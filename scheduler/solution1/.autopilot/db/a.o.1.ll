...
.preheader:                                       ; preds = %1
  %queue_head_ptr.0.lcssa = phi i32 [ %queue_head_ptr, %1 ] ; [#uses=1 type=i32]
  br label %11, !dbg !3688                        ; [debug line = 63:16]

; <label>:2                                       ; preds = %1
  %tmp = sext i32 %i to i64, !dbg !3690           ; [#uses=5 type=i64] [debug line = 18:8]
...
; <label>:3                                       ; preds = %2
  %sched_interfaces.addr.1 = getelementptr inbounds %struct.CoreScheduleInterface_t.29* %sched_interfaces, i64 %tmp, i32 0, i32 0, !dbg !3696 ; [#uses=1 type=i32*] [debug line = 21:56]
  %new_context.current_node = load i32* %sched_interfaces.addr.1, align 4, !dbg !3696 ; [#uses=6 type=i32] [debug line = 21:56]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %new_context.current_node) nounwind
  call void @llvm.dbg.value(metadata !{i32 %new_context.current_node}, i64 0, metadata !3698), !dbg !3696 ; [debug line = 21:56] [debug variable = new_context.current_node]
  %sched_interfaces.addr.2 = getelementptr inbounds %struct.CoreScheduleInterface_t.29* %sched_interfaces, i64 %tmp, i32 0, i32 1, !dbg !3696 ; [#uses=1 type=i32*] [debug line = 21:56]
  %new_context.next_node = load i32* %sched_interfaces.addr.2, align 4, !dbg !3696 ; [#uses=6 type=i32] [debug line = 21:56]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %new_context.next_node) nounwind
  call void @llvm.dbg.value(metadata !{i32 %new_context.next_node}, i64 0, metadata !3702), !dbg !3696 ; [debug line = 21:56] [debug variable = new_context.next_node]
  %sched_interfaces.addr.3 = getelementptr inbounds %struct.CoreScheduleInterface_t.29* %sched_interfaces, i64 %tmp, i32 0, i32 2, !dbg !3696 ; [#uses=1 type=i32*] [debug line = 21:56]
  %new_context.state = load i32* %sched_interfaces.addr.3, align 4, !dbg !3696 ; [#uses=6 type=i32] [debug line = 21:56]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %new_context.state) nounwind
  call void @llvm.dbg.value(metadata !{i32 %new_context.state}, i64 0, metadata !3705), !dbg !3696 ; [debug line = 21:56] [debug variable = new_context.state]
  %rbegin1 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !3708 ; [#uses=1 type=i32] [debug line = 27:6]
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, i8* getelementptr inbounds ([1 x i8]* @.str8, i64 0, i64 0)) nounwind, !dbg !3710 ; [debug line = 28:1]
  %sched_interfaces.addr.4 = getelementptr inbounds %struct.CoreScheduleInterface_t.29* %sched_interfaces, i64 %tmp, i32 2, i32 0, i32 0, i32 0, !dbg !3711 ; [#uses=1 type=i1*] [debug line = 280:10@29:2]
  store i1 false, i1* %sched_interfaces.addr.4, align 1, !dbg !3714 ; [debug line = 280:10@31:6]
  %rend68 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str7, i64 0, i64 0), i32 %rbegin1) nounwind, !dbg !3716 ; [#uses=0 type=i32] [debug line = 32:5]
  br label %4, !dbg !3717                         ; [debug line = 36:18]
...
; <label>:5                                       ; preds = %4
  %.not1 = icmp uge i32 %j, %history_head_ptr, !dbg !3719 ; [#uses=2 type=i1] [debug line = 38:6]
  %brmerge = or i1 %.not1, %match_found, !dbg !3719 ; [#uses=1 type=i1] [debug line = 38:6]
  %not..not = xor i1 %.not1, true, !dbg !3719     ; [#uses=1 type=i1] [debug line = 38:6]
  %match_found.0.mux = or i1 %match_found, %not..not, !dbg !3719 ; [#uses=1 type=i1] [debug line = 38:6]
  br i1 %brmerge, label %._crit_edge63, label %6, !dbg !3719 ; [debug line = 38:6]
...
._crit_edge63:                                    ; preds = %8, %7, %6, %5
  %match_found.1 = phi i1 [ %tmp.19, %8 ], [ %match_found.0.mux, %5 ], [ false, %6 ], [ false, %7 ] ; [#uses=1 type=i1]
  %j.1 = add nsw i32 %j, 1, !dbg !3723            ; [#uses=1 type=i32] [debug line = 36:30]
  call void @llvm.dbg.value(metadata !{i32 %j.1}, i64 0, metadata !3724), !dbg !3723 ; [debug line = 36:30] [debug variable = j]
  br label %4, !dbg !3723                         ; [debug line = 36:30]

; <label>:9                                       ; preds = %4
  %match_found.0.lcssa = phi i1 [ %match_found, %4 ] ; [#uses=1 type=i1]
  br i1 %match_found.0.lcssa, label %._crit_edge, label %10, !dbg !3725 ; [debug line = 47:5]
...
; <label>:10                                      ; preds = %9
  ...
  call void @llvm.dbg.value(metadata !{i32 %queue_head_ptr.5}, i64 0, metadata !3730), !dbg !3729 ; [debug line = 51:6] [debug variable = queue_head_ptr]
  %history_head_ptr.1 = add i32 %history_head_ptr, 1, !dbg !3731 ; [#uses=1 type=i32] [debug line = 52:6]
  call void @llvm.dbg.value(metadata !{i32 %history_head_ptr.1}, i64 0, metadata !3732), !dbg !3731 ; [debug line = 52:6] [debug variable = history_head_ptr]
  br label %._crit_edge, !dbg !3733               ; [debug line = 54:5]
...
; <label>:12                                      ; preds = %11
  %tmp.5 = sext i32 %i1 to i64, !dbg !3736        ; [#uses=5 type=i64] [debug line = 66:20]
  %setup_interfaces.addr = getelementptr inbounds %struct.CoreScheduleInterface_t.29* %setup_interfaces, i64 %tmp.5, i32 2, i32 0, i32 0, i32 0, !dbg !3738 ; [#uses=1 type=i1*] [debug line = 1979:9@3504:0@66:20]
  %setup_interfaces.load = load i1* %setup_interfaces.addr, align 1, !dbg !3738 ; [#uses=4 type=i1] [debug line = 1979:9@3504:0@66:20]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %setup_interfaces.load) nounwind
  %halted_flag.1 = and i1 %halted_flag, %setup_interfaces.load, !dbg !3736 ; [#uses=1 type=i1] [debug line = 66:20]
  call void @llvm.dbg.value(metadata !{i1 %halted_flag.1}, i64 0, metadata !3740), !dbg !3736 ; [debug line = 66:20] [debug variable = halted_flag]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %setup_interfaces.load) nounwind
  %.not = xor i1 %setup_interfaces.load, true, !dbg !3741 ; [#uses=1 type=i1] [debug line = 67:8]
  %tmp.7 = icmp eq i32 %queue_head_ptr.3, 0, !dbg !3741 ; [#uses=1 type=i1] [debug line = 67:8]
  %or.cond1 = or i1 %tmp.7, %.not, !dbg !3741     ; [#uses=1 type=i1] [debug line = 67:8]
  br i1 %or.cond1, label %._crit_edge66, label %13, !dbg !3741 ; [debug line = 67:8]
...
; <label>:13                                      ; preds = %12
  ...
  call void @llvm.dbg.value(metadata !{i32 %queue_head_ptr.1}, i64 0, metadata !3730), !dbg !3748 ; [debug line = 72:5] [debug variable = queue_head_ptr]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str17, i64 0, i64 0)) nounwind, !dbg !3749 ; [#uses=1 type=i32] [debug line = 77:6]
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, i8* getelementptr inbounds ([1 x i8]* @.str8, i64 0, i64 0)) nounwind, !dbg !3751 ; [debug line = 78:1]
  %setup_interfaces.addr.1 = getelementptr inbounds %struct.CoreScheduleInterface_t.29* %setup_interfaces, i64 %tmp.5, i32 0, i32 0, !dbg !3752 ; [#uses=1 type=i32*] [debug line = 79:2]
  store i32 %new_context.current_node.1, i32* %setup_interfaces.addr.1, align 4, !dbg !3752 ; [debug line = 79:2]
  %setup_interfaces.addr.2 = getelementptr inbounds %struct.CoreScheduleInterface_t.29* %setup_interfaces, i64 %tmp.5, i32 0, i32 1, !dbg !3752 ; [#uses=1 type=i32*] [debug line = 79:2]
  store i32 %new_context.next_node.1, i32* %setup_interfaces.addr.2, align 4, !dbg !3752 ; [debug line = 79:2]
  %setup_interfaces.addr.3 = getelementptr inbounds %struct.CoreScheduleInterface_t.29* %setup_interfaces, i64 %tmp.5, i32 0, i32 2, !dbg !3752 ; [#uses=1 type=i32*] [debug line = 79:2]
  store i32 %new_context.state.1, i32* %setup_interfaces.addr.3, align 4, !dbg !3752 ; [debug line = 79:2]
  %setup_interfaces.addr.4 = getelementptr inbounds %struct.CoreScheduleInterface_t.29* %setup_interfaces, i64 %tmp.5, i32 1, i32 0, i32 0, i32 0, !dbg !3753 ; [#uses=1 type=i1*] [debug line = 280:10@80:6]
  store i1 false, i1* %setup_interfaces.addr.4, align 1, !dbg !3755 ; [debug line = 280:10@82:6]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str17, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !3757 ; [#uses=0 type=i32] [debug line = 83:5]
  br label %._crit_edge66, !dbg !3758             ; [debug line = 84:4]
...
; <label>:14                                      ; preds = %11
  ...
  %queue_head_ptr.3.lcssa = phi i32 [ %queue_head_ptr.3, %11 ] ; [#uses=1 type=i32]
  %tmp.2 = icmp eq i32 %queue_head_ptr.3.lcssa, 0, !dbg !3761 ; [#uses=1 type=i1] [debug line = 86:3]
  %tmp.3 = and i1 %halted_flag.0.lcssa, %tmp.2, !dbg !3761 ; [#uses=1 type=i1] [debug line = 86:3]
  %tmp.4 = zext i1 %tmp.3 to i32, !dbg !3761      ; [#uses=1 type=i32] [debug line = 86:3]
  store i32 %tmp.4, i32* %finished, align 4, !dbg !3761 ; [debug line = 86:3]
  ret void, !dbg !3762                            ; [debug line = 88:1]
}
...
!3620 = metadata !{void (%struct.CoreScheduleInterface_t.29*, %struct.CoreScheduleInterface_t.29*, i32*)* @scheduler, metadata !3621, metadata !3622, metadata !3623, metadata !3624, metadata !3625, metadata !3626}
...
!3687 = metadata !{i32 786443, metadata !3673, i32 11, i32 2, metadata !902, i32 1} ; [ DW_TAG_lexical_block ]
!3688 = metadata !{i32 63, i32 16, metadata !3689, null}
!3689 = metadata !{i32 786443, metadata !3687, i32 63, i32 3, metadata !902, i32 10} ; [ DW_TAG_lexical_block ]
!3690 = metadata !{i32 18, i32 8, metadata !3691, null}
!3691 = metadata !{i32 786443, metadata !3686, i32 15, i32 3, metadata !902, i32 3} ; [ DW_TAG_lexical_block ]
!3692 = metadata !{i32 1979, i32 9, metadata !3693, metadata !3694}
!3693 = metadata !{i32 786443, metadata !1841, i32 1978, i32 107, metadata !891, i32 21} ; [ DW_TAG_lexical_block ]
!3694 = metadata !{i32 3504, i32 0, metadata !3695, metadata !3690}
!3695 = metadata !{i32 786443, metadata !1290, i32 3504, i32 333, metadata !891, i32 18} ; [ DW_TAG_lexical_block ]
!3696 = metadata !{i32 21, i32 56, metadata !3697, null}
!3697 = metadata !{i32 786443, metadata !3691, i32 19, i32 4, metadata !902, i32 4} ; [ DW_TAG_lexical_block ]
!3698 = metadata !{i32 790529, metadata !3699, metadata !"new_context.current_node", null, i32 21, metadata !3700, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3699 = metadata !{i32 786688, metadata !3697, metadata !"new_context", metadata !902, i32 21, metadata !911, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3700 = metadata !{i32 786438, null, metadata !"", metadata !908, i32 17, i64 32, i64 32, i32 0, i32 0, null, metadata !3701, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!3701 = metadata !{metadata !914}
!3702 = metadata !{i32 790529, metadata !3699, metadata !"new_context.next_node", null, i32 21, metadata !3703, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3703 = metadata !{i32 786438, null, metadata !"", metadata !908, i32 17, i64 32, i64 32, i32 0, i32 0, null, metadata !3704, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!3704 = metadata !{metadata !916}
!3705 = metadata !{i32 790529, metadata !3699, metadata !"new_context.state", null, i32 21, metadata !3706, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3706 = metadata !{i32 786438, null, metadata !"", metadata !908, i32 17, i64 32, i64 32, i32 0, i32 0, null, metadata !3707, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!3707 = metadata !{metadata !917}
!3708 = metadata !{i32 27, i32 6, metadata !3709, null}
!3709 = metadata !{i32 786443, metadata !3697, i32 27, i32 5, metadata !902, i32 5} ; [ DW_TAG_lexical_block ]
!3710 = metadata !{i32 28, i32 1, metadata !3709, null}
!3711 = metadata !{i32 280, i32 10, metadata !3712, metadata !3713}
!3712 = metadata !{i32 786443, metadata !1289, i32 279, i32 92, metadata !933, i32 17} ; [ DW_TAG_lexical_block ]
!3713 = metadata !{i32 29, i32 2, metadata !3709, null}
!3714 = metadata !{i32 280, i32 10, metadata !3712, metadata !3715}
!3715 = metadata !{i32 31, i32 6, metadata !3709, null}
!3716 = metadata !{i32 32, i32 5, metadata !3709, null}
!3717 = metadata !{i32 36, i32 18, metadata !3718, null}
!3718 = metadata !{i32 786443, metadata !3697, i32 36, i32 5, metadata !902, i32 6} ; [ DW_TAG_lexical_block ]
!3719 = metadata !{i32 38, i32 6, metadata !3720, null}
!3720 = metadata !{i32 786443, metadata !3718, i32 37, i32 5, metadata !902, i32 7} ; [ DW_TAG_lexical_block ]
!3721 = metadata !{i32 40, i32 7, metadata !3722, null}
!3722 = metadata !{i32 786443, metadata !3720, i32 39, i32 6, metadata !902, i32 8} ; [ DW_TAG_lexical_block ]
!3723 = metadata !{i32 36, i32 30, metadata !3718, null}
!3724 = metadata !{i32 786688, metadata !3718, metadata !"j", metadata !902, i32 36, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3725 = metadata !{i32 47, i32 5, metadata !3697, null}
!3726 = metadata !{i32 49, i32 6, metadata !3727, null}
!3727 = metadata !{i32 786443, metadata !3697, i32 48, i32 5, metadata !902, i32 9} ; [ DW_TAG_lexical_block ]
!3728 = metadata !{i32 50, i32 6, metadata !3727, null}
!3729 = metadata !{i32 51, i32 6, metadata !3727, null}
!3730 = metadata !{i32 786688, metadata !3673, metadata !"queue_head_ptr", metadata !902, i32 7, metadata !915, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!3738 = metadata !{i32 1979, i32 9, metadata !3693, metadata !3739}
!3739 = metadata !{i32 3504, i32 0, metadata !3695, metadata !3736}
!3740 = metadata !{i32 786688, metadata !3687, metadata !"halted_flag", metadata !902, i32 61, metadata !238, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3741 = metadata !{i32 67, i32 8, metadata !3737, null}
!3742 = metadata !{i32 71, i32 52, metadata !3743, null}
!3743 = metadata !{i32 786443, metadata !3737, i32 68, i32 4, metadata !902, i32 12} ; [ DW_TAG_lexical_block ]
!3744 = metadata !{i32 790529, metadata !3745, metadata !"new_context.current_node", null, i32 71, metadata !3700, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3745 = metadata !{i32 786688, metadata !3743, metadata !"new_context", metadata !902, i32 71, metadata !911, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3746 = metadata !{i32 790529, metadata !3745, metadata !"new_context.next_node", null, i32 71, metadata !3703, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3747 = metadata !{i32 790529, metadata !3745, metadata !"new_context.state", null, i32 71, metadata !3706, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3748 = metadata !{i32 72, i32 5, metadata !3743, null}
!3749 = metadata !{i32 77, i32 6, metadata !3750, null}
!3750 = metadata !{i32 786443, metadata !3743, i32 77, i32 5, metadata !902, i32 13} ; [ DW_TAG_lexical_block ]
!3751 = metadata !{i32 78, i32 1, metadata !3750, null}
!3752 = metadata !{i32 79, i32 2, metadata !3750, null}
!3753 = metadata !{i32 280, i32 10, metadata !3712, metadata !3754}
!3754 = metadata !{i32 80, i32 6, metadata !3750, null}
!3755 = metadata !{i32 280, i32 10, metadata !3712, metadata !3756}

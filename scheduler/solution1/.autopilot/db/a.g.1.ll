; ModuleID = '/home/parallels/Documents/ece527/final_project/scheduler/solution1/.autopilot/db/a.g.1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.CoreScheduleInterface_t.29 = type { %struct.context_t.25, %struct.ap_uint.28, %struct.ap_uint.28 }
%struct.context_t.25 = type { i32, i32, i32 }
...
; [#uses=0]
define void @scheduler(%struct.CoreScheduleInterface_t.29* %sched_interfaces, %struct.CoreScheduleInterface_t.29* %setup_interfaces) noreturn nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{%struct.CoreScheduleInterface_t.29* %sched_interfaces}, i64 0, metadata !3628), !dbg !3629 ; [debug line = 3:40] [debug variable = sched_interfaces]
  call void @llvm.dbg.value(metadata !{%struct.CoreScheduleInterface_t.29* %setup_interfaces}, i64 0, metadata !3630), !dbg !3631 ; [debug line = 3:84] [debug variable = setup_interfaces]
  call void (...)* @_ssdm_SpecArrayDimSize(%struct.CoreScheduleInterface_t.29* %sched_interfaces, i32 2) nounwind, !dbg !3632 ; [debug line = 4:2]
  call void (...)* @_ssdm_SpecArrayDimSize(%struct.CoreScheduleInterface_t.29* %setup_interfaces, i32 2) nounwind, !dbg !3634 ; [debug line = 4:45]
  call void @llvm.dbg.declare(metadata !{[4 x %struct.context_t.25]* %queue}, metadata !3635), !dbg !3639 ; [debug line = 6:12] [debug variable = queue]
  br label %.backedge, !dbg !3640                 ; [debug line = 10:2]

.backedge.loopexit:                               ; preds = %.preheader
  %queue_head_ptr.4.lcssa = phi i32 [ %queue_head_ptr.4, %.preheader ] ; [#uses=1 type=i32]
...
.backedge:                                        ; preds = %.backedge.backedge, %0
  ...
  %i = phi i32 [ 0, %0 ], [ %i.0.be, %.backedge.backedge ] ; [#uses=3 type=i32]
  %loop_begin = call i32 (...)* @_ssdm_op_SpecLoopBegin() nounwind ; [#uses=0 type=i32]
  %exitcond1 = icmp eq i32 %i, 2, !dbg !3641      ; [#uses=1 type=i1] [debug line = 13:16]
  br i1 %exitcond1, label %.preheader.preheader, label %1, !dbg !3641 ; [debug line = 13:16]

.preheader.preheader:                             ; preds = %.backedge
  br label %.preheader, !dbg !3644                ; [debug line = 50:16]

; <label>:1                                       ; preds = %.backedge
  %tmp = sext i32 %i to i64, !dbg !3646           ; [#uses=8 type=i64] [debug line = 16:8]
  %sched_interfaces.addr = getelementptr inbounds %struct.CoreScheduleInterface_t.29* %sched_interfaces, i64 %tmp, i32 1, i32 0, i32 0, i32 0, !dbg !3648 ; [#uses=1 type=i1*] [debug line = 1979:9@3504:0@16:8]
  %sched_interfaces.load = load i1* %sched_interfaces.addr, align 1, !dbg !3648 ; [#uses=2 type=i1] [debug line = 1979:9@3504:0@16:8]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %sched_interfaces.load) nounwind
  %tmp.1 = icmp ult i32 %queue_head_ptr.1, 4, !dbg !3646 ; [#uses=1 type=i1] [debug line = 16:8]
  %or.cond = and i1 %sched_interfaces.load, %tmp.1, !dbg !3646 ; [#uses=1 type=i1] [debug line = 16:8]
  br i1 %or.cond, label %_ZN7_ap_sc_7sc_core4waitEi.exit2, label %._crit_edge, !dbg !3646 ; [debug line = 16:8]

_ZN7_ap_sc_7sc_core4waitEi.exit2:                 ; preds = %1
  %sched_interfaces.addr.1 = getelementptr inbounds %struct.CoreScheduleInterface_t.29* %sched_interfaces, i64 %tmp, i32 0, i32 0, !dbg !3652 ; [#uses=2 type=i32*] [debug line = 19:56]
  %new_context.current_node = load i32* %sched_interfaces.addr.1, align 4, !dbg !3652 ; [#uses=1 type=i32] [debug line = 19:56]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %new_context.current_node) nounwind
  call void @llvm.dbg.value(metadata !{i32 %new_context.current_node}, i64 0, metadata !3654), !dbg !3652 ; [debug line = 19:56] [debug variable = new_context.current_node]
  %sched_interfaces.addr.2 = getelementptr inbounds %struct.CoreScheduleInterface_t.29* %sched_interfaces, i64 %tmp, i32 0, i32 1, !dbg !3652 ; [#uses=2 type=i32*] [debug line = 19:56]
  %new_context.next_node = load i32* %sched_interfaces.addr.2, align 4, !dbg !3652 ; [#uses=1 type=i32] [debug line = 19:56]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %new_context.next_node) nounwind
  call void @llvm.dbg.value(metadata !{i32 %new_context.next_node}, i64 0, metadata !3658), !dbg !3652 ; [debug line = 19:56] [debug variable = new_context.next_node]
  %sched_interfaces.addr.3 = getelementptr inbounds %struct.CoreScheduleInterface_t.29* %sched_interfaces, i64 %tmp, i32 0, i32 2, !dbg !3652 ; [#uses=2 type=i32*] [debug line = 19:56]
  %new_context.state = load i32* %sched_interfaces.addr.3, align 4, !dbg !3652 ; [#uses=1 type=i32] [debug line = 19:56]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %new_context.state) nounwind
  call void @llvm.dbg.value(metadata !{i32 %new_context.state}, i64 0, metadata !3661), !dbg !3652 ; [debug line = 19:56] [debug variable = new_context.state]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !3664 ; [#uses=1 type=i32] [debug line = 21:6]
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3666 ; [debug line = 22:1]
  %sched_interfaces.addr.4 = getelementptr inbounds %struct.CoreScheduleInterface_t.29* %sched_interfaces, i64 %tmp, i32 2, i32 0, i32 0, i32 0, !dbg !3667 ; [#uses=2 type=i1*] [debug line = 280:10@23:2]
  store i1 true, i1* %sched_interfaces.addr.4, align 1, !dbg !3667 ; [debug line = 280:10@23:2]
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !3670 ; [debug line = 803:19@24:6]
  store i1 false, i1* %sched_interfaces.addr.4, align 1, !dbg !3674 ; [debug line = 280:10@25:6]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !3676 ; [#uses=0 type=i32] [debug line = 26:5]
  %queue.addr = getelementptr inbounds [4 x %struct.context_t.25]* %queue, i64 0, i64 %tmp, i32 0, !dbg !3677 ; [#uses=1 type=i32*] [debug line = 43:6]
  %sched_interfaces.load.4 = load i32* %sched_interfaces.addr.1, align 4, !dbg !3677 ; [#uses=2 type=i32] [debug line = 43:6]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %sched_interfaces.load.4) nounwind
  store i32 %sched_interfaces.load.4, i32* %queue.addr, align 4, !dbg !3677 ; [debug line = 43:6]
  %queue.addr.1 = getelementptr inbounds [4 x %struct.context_t.25]* %queue, i64 0, i64 %tmp, i32 1, !dbg !3677 ; [#uses=1 type=i32*] [debug line = 43:6]
  %sched_interfaces.load.5 = load i32* %sched_interfaces.addr.2, align 4, !dbg !3677 ; [#uses=2 type=i32] [debug line = 43:6]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %sched_interfaces.load.5) nounwind
  store i32 %sched_interfaces.load.5, i32* %queue.addr.1, align 4, !dbg !3677 ; [debug line = 43:6]
  %queue.addr.2 = getelementptr inbounds [4 x %struct.context_t.25]* %queue, i64 0, i64 %tmp, i32 2, !dbg !3677 ; [#uses=1 type=i32*] [debug line = 43:6]
  %sched_interfaces.load.6 = load i32* %sched_interfaces.addr.3, align 4, !dbg !3677 ; [#uses=2 type=i32] [debug line = 43:6]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %sched_interfaces.load.6) nounwind
  store i32 %sched_interfaces.load.6, i32* %queue.addr.2, align 4, !dbg !3677 ; [debug line = 43:6]
  %queue_head_ptr = add i32 %queue_head_ptr.1, 1, !dbg !3679 ; [#uses=1 type=i32] [debug line = 44:6]
  call void @llvm.dbg.value(metadata !{i32 %queue_head_ptr}, i64 0, metadata !3680), !dbg !3679 ; [debug line = 44:6] [debug variable = queue_head_ptr]
  br label %._crit_edge, !dbg !3681               ; [debug line = 45:5]

._crit_edge:                                      ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit2, %1
  %queue_head_ptr.3 = phi i32 [ %queue_head_ptr, %_ZN7_ap_sc_7sc_core4waitEi.exit2 ], [ %queue_head_ptr.1, %1 ] ; [#uses=1 type=i32]
  %i.1 = add nsw i32 %i, 1, !dbg !3682            ; [#uses=1 type=i32] [debug line = 13:25]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !3683), !dbg !3682 ; [debug line = 13:25] [debug variable = i]
  br label %.backedge.backedge, !dbg !3682        ; [debug line = 13:25]

.backedge.backedge:                               ; preds = %._crit_edge, %.backedge.loopexit
  %queue_head_ptr.1.be = phi i32 [ %queue_head_ptr.3, %._crit_edge ], [ %queue_head_ptr.4.lcssa, %.backedge.loopexit ] ; [#uses=1 type=i32]
  %i.0.be = phi i32 [ %i.1, %._crit_edge ], [ 0, %.backedge.loopexit ] ; [#uses=1 type=i32]
  br label %.backedge
...
.preheader:                                       ; preds = %._crit_edge56, %.preheader.preheader
  ...
  %i1 = phi i32 [ %i.2, %._crit_edge56 ], [ 0, %.preheader.preheader ] ; [#uses=3 type=i32]
  %exitcond = icmp eq i32 %i1, 2, !dbg !3644      ; [#uses=1 type=i1] [debug line = 50:16]
  br i1 %exitcond, label %.backedge.loopexit, label %2, !dbg !3644 ; [debug line = 50:16]

; <label>:2                                       ; preds = %.preheader
  %tmp.4 = sext i32 %i1 to i64, !dbg !3684        ; [#uses=5 type=i64] [debug line = 52:8]
  %setup_interfaces.addr = getelementptr inbounds %struct.CoreScheduleInterface_t.29* %setup_interfaces, i64 %tmp.4, i32 2, i32 0, i32 0, i32 0, !dbg !3686 ; [#uses=1 type=i1*] [debug line = 1979:9@3504:0@52:8]
  %setup_interfaces.load = load i1* %setup_interfaces.addr, align 1, !dbg !3684 ; [#uses=2 type=i1] [debug line = 52:8]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %setup_interfaces.load) nounwind
  %.not = xor i1 %setup_interfaces.load, true, !dbg !3684 ; [#uses=1 type=i1] [debug line = 52:8]
  %tmp.5 = icmp eq i32 %queue_head_ptr.4, 0, !dbg !3684 ; [#uses=1 type=i1] [debug line = 52:8]
  %or.cond1 = or i1 %tmp.5, %.not, !dbg !3684     ; [#uses=1 type=i1] [debug line = 52:8]
  br i1 %or.cond1, label %._crit_edge56, label %_ZN7_ap_sc_7sc_core4waitEi.exit, !dbg !3684 ; [debug line = 52:8]

_ZN7_ap_sc_7sc_core4waitEi.exit:                  ; preds = %2
  %tmp.6 = zext i32 %queue_head_ptr.4 to i64, !dbg !3688 ; [#uses=3 type=i64] [debug line = 55:50]
  %queue.addr.3 = getelementptr inbounds [4 x %struct.context_t.25]* %queue, i64 0, i64 %tmp.6, i32 0, !dbg !3688 ; [#uses=1 type=i32*] [debug line = 55:50]
  %new_context.current_node.1 = load i32* %queue.addr.3, align 4, !dbg !3688 ; [#uses=2 type=i32] [debug line = 55:50]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %new_context.current_node.1) nounwind
  call void @llvm.dbg.value(metadata !{i32 %new_context.current_node.1}, i64 0, metadata !3690), !dbg !3688 ; [debug line = 55:50] [debug variable = new_context.current_node]
  %queue.addr.4 = getelementptr inbounds [4 x %struct.context_t.25]* %queue, i64 0, i64 %tmp.6, i32 1, !dbg !3688 ; [#uses=1 type=i32*] [debug line = 55:50]
  %new_context.next_node.1 = load i32* %queue.addr.4, align 4, !dbg !3688 ; [#uses=2 type=i32] [debug line = 55:50]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %new_context.next_node.1) nounwind
  call void @llvm.dbg.value(metadata !{i32 %new_context.next_node.1}, i64 0, metadata !3692), !dbg !3688 ; [debug line = 55:50] [debug variable = new_context.next_node]
  %queue.addr.5 = getelementptr inbounds [4 x %struct.context_t.25]* %queue, i64 0, i64 %tmp.6, i32 2, !dbg !3688 ; [#uses=1 type=i32*] [debug line = 55:50]
  %new_context.state.1 = load i32* %queue.addr.5, align 4, !dbg !3688 ; [#uses=2 type=i32] [debug line = 55:50]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %new_context.state.1) nounwind
  call void @llvm.dbg.value(metadata !{i32 %new_context.state.1}, i64 0, metadata !3693), !dbg !3688 ; [debug line = 55:50] [debug variable = new_context.state]
  %queue_head_ptr.2 = add i32 %queue_head_ptr.4, -1, !dbg !3694 ; [#uses=1 type=i32] [debug line = 56:5]
  call void @llvm.dbg.value(metadata !{i32 %queue_head_ptr.2}, i64 0, metadata !3680), !dbg !3694 ; [debug line = 56:5] [debug variable = queue_head_ptr]
  %rbegin1 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !3695 ; [#uses=1 type=i32] [debug line = 59:6]
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !3697 ; [debug line = 60:1]
  %setup_interfaces.addr.1 = getelementptr inbounds %struct.CoreScheduleInterface_t.29* %setup_interfaces, i64 %tmp.4, i32 0, i32 0, !dbg !3698 ; [#uses=1 type=i32*] [debug line = 61:2]
  store i32 %new_context.current_node.1, i32* %setup_interfaces.addr.1, align 4, !dbg !3698 ; [debug line = 61:2]
  %setup_interfaces.addr.2 = getelementptr inbounds %struct.CoreScheduleInterface_t.29* %setup_interfaces, i64 %tmp.4, i32 0, i32 1, !dbg !3698 ; [#uses=1 type=i32*] [debug line = 61:2]
  store i32 %new_context.next_node.1, i32* %setup_interfaces.addr.2, align 4, !dbg !3698 ; [debug line = 61:2]
  %setup_interfaces.addr.3 = getelementptr inbounds %struct.CoreScheduleInterface_t.29* %setup_interfaces, i64 %tmp.4, i32 0, i32 2, !dbg !3698 ; [#uses=1 type=i32*] [debug line = 61:2]
  store i32 %new_context.state.1, i32* %setup_interfaces.addr.3, align 4, !dbg !3698 ; [debug line = 61:2]
  %setup_interfaces.addr.4 = getelementptr inbounds %struct.CoreScheduleInterface_t.29* %setup_interfaces, i64 %tmp.4, i32 1, i32 0, i32 0, i32 0, !dbg !3699 ; [#uses=2 type=i1*] [debug line = 280:10@62:6]
  store i1 true, i1* %setup_interfaces.addr.4, align 1, !dbg !3699 ; [debug line = 280:10@62:6]
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !3701 ; [debug line = 803:19@63:6]
  store i1 false, i1* %setup_interfaces.addr.4, align 1, !dbg !3703 ; [debug line = 280:10@64:6]
  %rend58 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str2, i64 0, i64 0), i32 %rbegin1) nounwind, !dbg !3705 ; [#uses=0 type=i32] [debug line = 65:5]
  br label %._crit_edge56, !dbg !3706             ; [debug line = 66:4]

._crit_edge56:                                    ; preds = %_ZN7_ap_sc_7sc_core4waitEi.exit, %2
  %queue_head_ptr.5 = phi i32 [ %queue_head_ptr.2, %_ZN7_ap_sc_7sc_core4waitEi.exit ], [ %queue_head_ptr.4, %2 ] ; [#uses=1 type=i32]
  %i.2 = add nsw i32 %i1, 1, !dbg !3707           ; [#uses=1 type=i32] [debug line = 50:25]
  call void @llvm.dbg.value(metadata !{i32 %i.2}, i64 0, metadata !3708), !dbg !3707 ; [debug line = 50:25] [debug variable = i]
  br label %.preheader, !dbg !3707                ; [debug line = 50:25]
}
...
!3596 = metadata !{void (%struct.CoreScheduleInterface_t.29*, %struct.CoreScheduleInterface_t.29*)* @scheduler, metadata !3597, metadata !3598, metadata !3599, metadata !3600, metadata !3601, metadata !3602}
...
!3628 = metadata !{i32 786689, metadata !901, metadata !"sched_interfaces", metadata !902, i32 16777219, metadata !905, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3629 = metadata !{i32 3, i32 40, metadata !901, null}
!3630 = metadata !{i32 786689, metadata !901, metadata !"setup_interfaces", metadata !902, i32 33554435, metadata !1277, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3631 = metadata !{i32 3, i32 84, metadata !901, null}
!3632 = metadata !{i32 4, i32 2, metadata !3633, null}
!3633 = metadata !{i32 786443, metadata !901, i32 4, i32 1, metadata !902, i32 0} ; [ DW_TAG_lexical_block ]
!3634 = metadata !{i32 4, i32 45, metadata !3633, null}
!3635 = metadata !{i32 786688, metadata !3633, metadata !"queue", metadata !902, i32 6, metadata !3636, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3636 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 384, i64 32, i32 0, i32 0, metadata !911, metadata !3637, i32 0, i32 0} ; [ DW_TAG_array_type ]
!3637 = metadata !{metadata !3638}
!3638 = metadata !{i32 786465, i64 0, i64 3}      ; [ DW_TAG_subrange_type ]
!3639 = metadata !{i32 6, i32 12, metadata !3633, null}
!3640 = metadata !{i32 10, i32 2, metadata !3633, null}
!3641 = metadata !{i32 13, i32 16, metadata !3642, null}
!3642 = metadata !{i32 786443, metadata !3643, i32 13, i32 3, metadata !902, i32 2} ; [ DW_TAG_lexical_block ]
!3643 = metadata !{i32 786443, metadata !3633, i32 11, i32 2, metadata !902, i32 1} ; [ DW_TAG_lexical_block ]
!3644 = metadata !{i32 50, i32 16, metadata !3645, null}
!3645 = metadata !{i32 786443, metadata !3643, i32 50, i32 3, metadata !902, i32 10} ; [ DW_TAG_lexical_block ]
!3646 = metadata !{i32 16, i32 8, metadata !3647, null}
!3647 = metadata !{i32 786443, metadata !3642, i32 14, i32 3, metadata !902, i32 3} ; [ DW_TAG_lexical_block ]
!3648 = metadata !{i32 1979, i32 9, metadata !3649, metadata !3650}
!3649 = metadata !{i32 786443, metadata !1840, i32 1978, i32 107, metadata !891, i32 21} ; [ DW_TAG_lexical_block ]
!3650 = metadata !{i32 3504, i32 0, metadata !3651, metadata !3646}
!3651 = metadata !{i32 786443, metadata !1289, i32 3504, i32 333, metadata !891, i32 18} ; [ DW_TAG_lexical_block ]
!3652 = metadata !{i32 19, i32 56, metadata !3653, null}
!3653 = metadata !{i32 786443, metadata !3647, i32 17, i32 4, metadata !902, i32 4} ; [ DW_TAG_lexical_block ]
!3654 = metadata !{i32 790529, metadata !3655, metadata !"new_context.current_node", null, i32 19, metadata !3656, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3655 = metadata !{i32 786688, metadata !3653, metadata !"new_context", metadata !902, i32 19, metadata !911, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3656 = metadata !{i32 786438, null, metadata !"", metadata !908, i32 15, i64 32, i64 32, i32 0, i32 0, null, metadata !3657, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!3657 = metadata !{metadata !914}
!3658 = metadata !{i32 790529, metadata !3655, metadata !"new_context.next_node", null, i32 19, metadata !3659, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3659 = metadata !{i32 786438, null, metadata !"", metadata !908, i32 15, i64 32, i64 32, i32 0, i32 0, null, metadata !3660, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!3660 = metadata !{metadata !916}
!3661 = metadata !{i32 790529, metadata !3655, metadata !"new_context.state", null, i32 19, metadata !3662, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3662 = metadata !{i32 786438, null, metadata !"", metadata !908, i32 15, i64 32, i64 32, i32 0, i32 0, null, metadata !3663, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!3663 = metadata !{metadata !917}
!3664 = metadata !{i32 21, i32 6, metadata !3665, null}
!3665 = metadata !{i32 786443, metadata !3653, i32 21, i32 5, metadata !902, i32 5} ; [ DW_TAG_lexical_block ]
!3666 = metadata !{i32 22, i32 1, metadata !3665, null}
!3667 = metadata !{i32 280, i32 10, metadata !3668, metadata !3669}
!3668 = metadata !{i32 786443, metadata !1288, i32 279, i32 92, metadata !933, i32 17} ; [ DW_TAG_lexical_block ]
!3669 = metadata !{i32 23, i32 2, metadata !3665, null}
!3670 = metadata !{i32 803, i32 19, metadata !3671, metadata !3673}
!3671 = metadata !{i32 786443, metadata !3672, i32 803, i32 17, metadata !1846, i32 23} ; [ DW_TAG_lexical_block ]
!3672 = metadata !{i32 786443, metadata !1843, i32 802, i32 58, metadata !1846, i32 22} ; [ DW_TAG_lexical_block ]
!3673 = metadata !{i32 24, i32 6, metadata !3665, null}
!3674 = metadata !{i32 280, i32 10, metadata !3668, metadata !3675}
!3675 = metadata !{i32 25, i32 6, metadata !3665, null}
!3676 = metadata !{i32 26, i32 5, metadata !3665, null}
!3677 = metadata !{i32 43, i32 6, metadata !3678, null}
!3678 = metadata !{i32 786443, metadata !3653, i32 42, i32 5, metadata !902, i32 9} ; [ DW_TAG_lexical_block ]
!3679 = metadata !{i32 44, i32 6, metadata !3678, null}
!3680 = metadata !{i32 786688, metadata !3633, metadata !"queue_head_ptr", metadata !902, i32 7, metadata !915, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3681 = metadata !{i32 45, i32 5, metadata !3678, null}
!3682 = metadata !{i32 13, i32 25, metadata !3642, null}
!3683 = metadata !{i32 786688, metadata !3642, metadata !"i", metadata !902, i32 13, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3684 = metadata !{i32 52, i32 8, metadata !3685, null}
!3685 = metadata !{i32 786443, metadata !3645, i32 51, i32 3, metadata !902, i32 11} ; [ DW_TAG_lexical_block ]
!3686 = metadata !{i32 1979, i32 9, metadata !3649, metadata !3687}
!3687 = metadata !{i32 3504, i32 0, metadata !3651, metadata !3684}
!3688 = metadata !{i32 55, i32 50, metadata !3689, null}
!3689 = metadata !{i32 786443, metadata !3685, i32 53, i32 4, metadata !902, i32 12} ; [ DW_TAG_lexical_block ]
!3690 = metadata !{i32 790529, metadata !3691, metadata !"new_context.current_node", null, i32 55, metadata !3656, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3691 = metadata !{i32 786688, metadata !3689, metadata !"new_context", metadata !902, i32 55, metadata !911, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3692 = metadata !{i32 790529, metadata !3691, metadata !"new_context.next_node", null, i32 55, metadata !3659, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3693 = metadata !{i32 790529, metadata !3691, metadata !"new_context.state", null, i32 55, metadata !3662, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3694 = metadata !{i32 56, i32 5, metadata !3689, null}
!3695 = metadata !{i32 59, i32 6, metadata !3696, null}
!3696 = metadata !{i32 786443, metadata !3689, i32 59, i32 5, metadata !902, i32 13} ; [ DW_TAG_lexical_block ]
!3697 = metadata !{i32 60, i32 1, metadata !3696, null}
!3698 = metadata !{i32 61, i32 2, metadata !3696, null}
!3699 = metadata !{i32 280, i32 10, metadata !3668, metadata !3700}
!3700 = metadata !{i32 62, i32 6, metadata !3696, null}
!3701 = metadata !{i32 803, i32 19, metadata !3671, metadata !3702}
!3702 = metadata !{i32 63, i32 6, metadata !3696, null}
!3703 = metadata !{i32 280, i32 10, metadata !3668, metadata !3704}
!3704 = metadata !{i32 64, i32 6, metadata !3696, null}
!3705 = metadata !{i32 65, i32 5, metadata !3696, null}
!3706 = metadata !{i32 66, i32 4, metadata !3689, null}
!3707 = metadata !{i32 50, i32 25, metadata !3645, null}
!3708 = metadata !{i32 786688, metadata !3645, metadata !"i", metadata !902, i32 50, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]

...
set C_modelArgList {
	{ sched_interfaces_context_current_node int 32 regular {array 2 { 1 3 } 1 1 }  }
	{ sched_interfaces_context_next_node int 32 regular {array 2 { 1 3 } 1 1 }  }
	{ sched_interfaces_context_state int 32 regular {array 2 { 1 3 } 1 1 }  }
	{ sched_interfaces_schedule_V int 1 regular {array 2 { 1 3 } 1 1 }  }
	{ sched_interfaces_ack_V int 1 regular {array 2 { 0 3 } 0 1 }  }
	{ setup_interfaces_context_current_node int 32 regular {array 2 { 0 3 } 0 1 }  }
	{ setup_interfaces_context_next_node int 32 regular {array 2 { 0 3 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "sched_interfaces_context_current_node", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "sched_interfaces.context.current_node","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 1,"step" : 1}]}]}]} , 
 	{ "Name" : "sched_interfaces_context_next_node", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "sched_interfaces.context.next_node","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 1,"step" : 1}]}]}]} , 
 	{ "Name" : "sched_interfaces_context_state", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "sched_interfaces.context.state","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 1,"step" : 1}]}]}]} , 
 	{ "Name" : "sched_interfaces_schedule_V", "interface" : "memory", "bitwidth" : 1, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "sched_interfaces.schedule.V","cData": "uint1","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 1,"step" : 1}]}]}]} , 
 	{ "Name" : "sched_interfaces_ack_V", "interface" : "memory", "bitwidth" : 1, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "sched_interfaces.ack.V","cData": "uint1","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 1,"step" : 1}]}]}]} , 
 	{ "Name" : "setup_interfaces_context_current_node", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "setup_interfaces.context.current_node","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 1,"step" : 1}]}]}]} , 
...
set portList { 
	...
	{ sched_interfaces_context_current_node_address0 sc_out sc_lv 1 signal 0 } 
	...
	{ sched_interfaces_context_next_node_address0 sc_out sc_lv 1 signal 1 } 
	...
	{ setup_interfaces_context_current_node_address0 sc_out sc_lv 1 signal 5 } 
	...
	{ setup_interfaces_context_next_node_address0 sc_out sc_lv 1 signal 6 } 
	...
	{ setup_interfaces_context_state_address0 sc_out sc_lv 1 signal 7 } 
	...
	{ setup_interfaces_restart_V_address0 sc_out sc_lv 1 signal 8 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sched_interfaces_context_current_node_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "sched_interfaces_context_current_node", "role": "address0" }} , 
 	...
 	{ "name": "sched_interfaces_context_next_node_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "sched_interfaces_context_next_node", "role": "address0" }} , 
 	...
 	{ "name": "sched_interfaces_context_state_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "sched_interfaces_context_state", "role": "address0" }} , 
 	...
 	{ "name": "sched_interfaces_schedule_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "sched_interfaces_schedule_V", "role": "address0" }} , 
 	...
 	{ "name": "sched_interfaces_ack_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "sched_interfaces_ack_V", "role": "address0" }} , 
 	...
 	{ "name": "setup_interfaces_context_current_node_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "setup_interfaces_context_current_node", "role": "address0" }} , 
 	...
 	{ "name": "setup_interfaces_context_next_node_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "setup_interfaces_context_next_node", "role": "address0" }} , 
 	...
 	{ "name": "setup_interfaces_context_state_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "setup_interfaces_context_state", "role": "address0" }} , 
 	...
 	{ "name": "setup_interfaces_restart_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "setup_interfaces_restart_V", "role": "address0" }} , 
...
set ArgLastReadFirstWriteLatency {
	scheduler {
		...
		setup_interfaces_context_current_node {Type O LastRead -1 FirstWrite 4}
...
set Spec2ImplPortList { 
	sched_interfaces_context_current_node { ap_memory {  { sched_interfaces_context_current_node_address0 mem_address 1 1 }  { sched_interfaces_context_current_node_ce0 mem_ce 1 1 }  { sched_interfaces_context_current_node_q0 mem_dout 0 32 } } }
	sched_interfaces_context_next_node { ap_memory {  { sched_interfaces_context_next_node_address0 mem_address 1 1 }  { sched_interfaces_context_next_node_ce0 mem_ce 1 1 }  { sched_interfaces_context_next_node_q0 mem_dout 0 32 } } }
	sched_interfaces_context_state { ap_memory {  { sched_interfaces_context_state_address0 mem_address 1 1 }  { sched_interfaces_context_state_ce0 mem_ce 1 1 }  { sched_interfaces_context_state_q0 mem_dout 0 32 } } }
	sched_interfaces_schedule_V { ap_memory {  { sched_interfaces_schedule_V_address0 mem_address 1 1 }  { sched_interfaces_schedule_V_ce0 mem_ce 1 1 }  { sched_interfaces_schedule_V_q0 mem_dout 0 1 } } }
	sched_interfaces_ack_V { ap_memory {  { sched_interfaces_ack_V_address0 mem_address 1 1 }  { sched_interfaces_ack_V_ce0 mem_ce 1 1 }  { sched_interfaces_ack_V_we0 mem_we 1 1 }  { sched_interfaces_ack_V_d0 mem_din 1 1 } } }
	setup_interfaces_context_current_node { ap_memory {  { setup_interfaces_context_current_node_address0 mem_address 1 1 }  { setup_interfaces_context_current_node_ce0 mem_ce 1 1 }  { setup_interfaces_context_current_node_we0 mem_we 1 1 }  { setup_interfaces_context_current_node_d0 mem_din 1 32 } } }
	setup_interfaces_context_next_node { ap_memory {  { setup_interfaces_context_next_node_address0 mem_address 1 1 }  { setup_interfaces_context_next_node_ce0 mem_ce 1 1 }  { setup_interfaces_context_next_node_we0 mem_we 1 1 }  { setup_interfaces_context_next_node_d0 mem_din 1 32 } } }

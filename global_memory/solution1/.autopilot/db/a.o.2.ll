...
@global_memory.str = internal unnamed_addr constant [14 x i8] c"global_memory\00" ; [#uses=1 type=[14 x i8]*]
@.str7 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1 ; [#uses=2 type=[1 x i8]*]
@.str6 = private unnamed_addr constant [12 x i8] c"hls_label_1\00", align 1 ; [#uses=2 type=[12 x i8]*]
@.str11 = private unnamed_addr constant [12 x i8] c"hls_label_0\00", align 1 ; [#uses=2 type=[12 x i8]*]
...
; [#uses=0]
define void @global_memory([2 x i32]* %mem_interfaces.request.address, [2 x i32]* %mem_interfaces.request.data, [2 x i2]* %mem_interfaces.request.op.V, [2 x i32]* %mem_interfaces.result, [2 x i1]* %mem_interfaces.ack.V, [2 x i1]* %mem_interfaces.req.V) {
  call void (...)* @_ssdm_op_SpecBitsMap([2 x i32]* %mem_interfaces.request.address), !map !3480
  call void (...)* @_ssdm_op_SpecBitsMap([2 x i32]* %mem_interfaces.request.data), !map !3486
  call void (...)* @_ssdm_op_SpecBitsMap([2 x i2]* %mem_interfaces.request.op.V), !map !3490
  call void (...)* @_ssdm_op_SpecBitsMap([2 x i32]* %mem_interfaces.result), !map !3494
  call void (...)* @_ssdm_op_SpecBitsMap([2 x i1]* %mem_interfaces.ack.V), !map !3498
  call void (...)* @_ssdm_op_SpecBitsMap([2 x i1]* %mem_interfaces.req.V), !map !3502
  call void (...)* @_ssdm_op_SpecTopModule([14 x i8]* @global_memory.str) nounwind
  %global_memory = alloca [1024 x i32], align 16  ; [#uses=1 type=[1024 x i32]*]
  call void @llvm.dbg.value(metadata !{[2 x i32]* %mem_interfaces.request.address}, i64 0, metadata !3506), !dbg !3515 ; [debug line = 3:48] [debug variable = mem_interfaces.request.address]
  call void @llvm.dbg.value(metadata !{[2 x i32]* %mem_interfaces.request.data}, i64 0, metadata !3516), !dbg !3515 ; [debug line = 3:48] [debug variable = mem_interfaces.request.data]
  call void @llvm.dbg.value(metadata !{[2 x i2]* %mem_interfaces.request.op.V}, i64 0, metadata !3522), !dbg !3515 ; [debug line = 3:48] [debug variable = mem_interfaces.request.op.V]
  call void @llvm.dbg.value(metadata !{[2 x i32]* %mem_interfaces.result}, i64 0, metadata !3534), !dbg !3515 ; [debug line = 3:48] [debug variable = mem_interfaces.result]
  call void @llvm.dbg.value(metadata !{[2 x i1]* %mem_interfaces.ack.V}, i64 0, metadata !3538), !dbg !3515 ; [debug line = 3:48] [debug variable = mem_interfaces.ack.V]
  call void @llvm.dbg.value(metadata !{[2 x i1]* %mem_interfaces.req.V}, i64 0, metadata !3548), !dbg !3515 ; [debug line = 3:48] [debug variable = mem_interfaces.req.V]
  call void @llvm.dbg.declare(metadata !{[1024 x i32]* %global_memory}, metadata !3549), !dbg !3554 ; [debug line = 5:6] [debug variable = global_memory]
  br label %1, !dbg !3555                         ; [debug line = 10:16]

; <label>:1                                       ; preds = %._crit_edge, %0
  %i = phi i2 [ 0, %0 ], [ %i.1, %._crit_edge ]   ; [#uses=3 type=i2]
  %exitcond1 = icmp eq i2 %i, -2, !dbg !3555      ; [#uses=1 type=i1] [debug line = 10:16]
  %2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 2, i64 2, i64 2) ; [#uses=0 type=i32]
  br i1 %exitcond1, label %.preheader.preheader_ifconv, label %3, !dbg !3555 ; [debug line = 10:16]

.preheader.preheader_ifconv:                      ; preds = %1
  ret void, !dbg !3558                            ; [debug line = 64:1]

; <label>:3                                       ; preds = %1
  %tmp = zext i2 %i to i64, !dbg !3559            ; [#uses=6 type=i64] [debug line = 14:7]
  %mem_interfaces.req.V.addr = getelementptr [2 x i1]* %mem_interfaces.req.V, i64 0, i64 %tmp, !dbg !3561 ; [#uses=1 type=i1*] [debug line = 1655:70@14:7]
  %mem_interfaces.req.V.load = load i1* %mem_interfaces.req.V.addr, align 1, !dbg !3561 ; [#uses=1 type=i1] [debug line = 1655:70@14:7]
  br i1 %mem_interfaces.req.V.load, label %_ifconv, label %._crit_edge, !dbg !3559 ; [debug line = 14:7]

_ifconv:                                          ; preds = %3
  %mem_interfaces.request.addr = getelementptr [2 x i32]* %mem_interfaces.request.address, i64 0, i64 %tmp, !dbg !3563 ; [#uses=1 type=i32*] [debug line = 16:52]
  %request.address = load i32* %mem_interfaces.request.addr, align 4, !dbg !3563 ; [#uses=1 type=i32] [debug line = 16:52]
  call void @llvm.dbg.value(metadata !{i32 %request.address}, i64 0, metadata !3565), !dbg !3563 ; [debug line = 16:52] [debug variable = request.address]
  %mem_interfaces.request.data.addr = getelementptr [2 x i32]* %mem_interfaces.request.data, i64 0, i64 %tmp, !dbg !3563 ; [#uses=1 type=i32*] [debug line = 16:52]
  %request.data = load i32* %mem_interfaces.request.data.addr, align 4, !dbg !3563 ; [#uses=4 type=i32] [debug line = 16:52]
  call void @llvm.dbg.value(metadata !{i32 %request.data}, i64 0, metadata !3567), !dbg !3563 ; [debug line = 16:52] [debug variable = request.data]
  %mem_interfaces.request.op.V.addr = getelementptr [2 x i2]* %mem_interfaces.request.op.V, i64 0, i64 %tmp, !dbg !3563 ; [#uses=1 type=i2*] [debug line = 16:52]
  %request.op.V = load i2* %mem_interfaces.request.op.V.addr, align 1, !dbg !3563 ; [#uses=3 type=i2] [debug line = 16:52]
  call void @llvm.dbg.value(metadata !{i2 %request.op.V}, i64 0, metadata !3568), !dbg !3563 ; [debug line = 16:52] [debug variable = request.op.V]
  %tmp.2 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str6), !dbg !3569 ; [#uses=1 type=i32] [debug line = 25:6]
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, [1 x i8]* @.str7) nounwind, !dbg !3571 ; [debug line = 26:1]
  %tmp.1 = sext i32 %request.address to i64, !dbg !3572 ; [#uses=1 type=i64] [debug line = 30:52]
  %global_memory.addr = getelementptr inbounds [1024 x i32]* %global_memory, i64 0, i64 %tmp.1, !dbg !3572 ; [#uses=2 type=i32*] [debug line = 30:52]
  %result.7 = load i32* %global_memory.addr, align 4, !dbg !3572 ; [#uses=5 type=i32] [debug line = 30:52]
  call void @llvm.dbg.value(metadata !{i32 %result.7}, i64 0, metadata !3573), !dbg !3574 ; [debug line = 39:16] [debug variable = result]
  call void @llvm.dbg.value(metadata !{i32 %result.7}, i64 0, metadata !3576), !dbg !3572 ; [debug line = 30:52] [debug variable = read_data]
  %result = add nsw i32 %request.data, %result.7, !dbg !3577 ; [#uses=1 type=i32] [debug line = 36:15]
  call void @llvm.dbg.value(metadata !{i32 %result}, i64 0, metadata !3573), !dbg !3577 ; [debug line = 36:15] [debug variable = result]
  %tmp.6 = icmp sgt i32 %result.7, %request.data, !dbg !3578 ; [#uses=2 type=i1] [debug line = 37:15]
  %request.data.2 = select i1 %tmp.6, i32 %request.data, i32 %result.7, !dbg !3578 ; [#uses=1 type=i32] [debug line = 37:15]
  call void @llvm.dbg.value(metadata !{i32 %request.data.2}, i64 0, metadata !3567), !dbg !3578 ; [debug line = 37:15] [debug variable = request.data]
  call void @llvm.dbg.value(metadata !{i32 %request.data.2}, i64 0, metadata !3573), !dbg !3578 ; [debug line = 37:15] [debug variable = result]
  %result.2 = select i1 %tmp.6, i32 %result.7, i32 %request.data, !dbg !3579 ; [#uses=1 type=i32] [debug line = 38:15]
  call void @llvm.dbg.value(metadata !{i32 %result.2}, i64 0, metadata !3573), !dbg !3579 ; [debug line = 38:15] [debug variable = result]
  %sel_tmp = icmp eq i2 %request.op.V, -1         ; [#uses=1 type=i1]
  %result.4 = select i1 %sel_tmp, i32 %result.2, i32 %result.7 ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %result.4}, i64 0, metadata !3573), !dbg !3578 ; [debug line = 37:15] [debug variable = result]
  %sel_tmp2 = icmp eq i2 %request.op.V, -2        ; [#uses=1 type=i1]
  %result.5 = select i1 %sel_tmp2, i32 %request.data.2, i32 %result.4 ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %result.5}, i64 0, metadata !3573), !dbg !3578 ; [debug line = 37:15] [debug variable = result]
  %sel_tmp4 = icmp eq i2 %request.op.V, 1         ; [#uses=1 type=i1]
  %result.6 = select i1 %sel_tmp4, i32 %result, i32 %result.5 ; [#uses=2 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %result.6}, i64 0, metadata !3573), !dbg !3578 ; [debug line = 37:15] [debug variable = result]
  store i32 %result.6, i32* %global_memory.addr, align 4, !dbg !3580 ; [debug line = 44:6]
  %4 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str6, i32 %tmp.2), !dbg !3581 ; [#uses=0 type=i32] [debug line = 45:5]
  %tmp.4 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str11), !dbg !3582 ; [#uses=1 type=i32] [debug line = 47:6]
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, [1 x i8]* @.str7) nounwind, !dbg !3584 ; [debug line = 48:1]
  %mem_interfaces.result.addr = getelementptr [2 x i32]* %mem_interfaces.result, i64 0, i64 %tmp, !dbg !3585 ; [#uses=1 type=i32*] [debug line = 51:6]
  store i32 %result.6, i32* %mem_interfaces.result.addr, align 4, !dbg !3585 ; [debug line = 51:6]
  %mem_interfaces.ack.V.addr = getelementptr [2 x i1]* %mem_interfaces.ack.V, i64 0, i64 %tmp, !dbg !3586 ; [#uses=1 type=i1*] [debug line = 280:10@52:6]
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !3589 ; [debug line = 53:6]
  store i1 false, i1* %mem_interfaces.ack.V.addr, align 1, !dbg !3590 ; [debug line = 280:10@54:6]
  %5 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str11, i32 %tmp.4), !dbg !3592 ; [#uses=0 type=i32] [debug line = 55:5]
  br label %._crit_edge, !dbg !3593               ; [debug line = 56:4]

._crit_edge:                                      ; preds = %_ifconv, %3
  %i.1 = add i2 %i, 1, !dbg !3594                 ; [#uses=1 type=i2] [debug line = 10:25]
  call void @llvm.dbg.value(metadata !{i2 %i.1}, i64 0, metadata !3595), !dbg !3594 ; [debug line = 10:25] [debug variable = i]
  br label %1, !dbg !3594                         ; [debug line = 10:25]
}
...
!llvm.dbg.cu = !{!0}
!opencl.kernels = !{!3433, !3440, !3440, !3444, !3444, !3450, !3444, !3453, !3444, !3459, !3462, !3465, !3468, !3465, !3470, !3468}
!hls.encrypted.func = !{}
!llvm.map.gv = !{!3473}
...
!901 = metadata !{i32 786478, i32 0, metadata !902, metadata !"global_memory", metadata !"global_memory", metadata !"_Z13global_memoryP27CoreGlobalMemoryInterface_t", metadata !902, i32 3, metadata !903, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !89, i32 4} ; [ DW_TAG_subprogram ]
...
!1647 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi1EEC1Ei", metadata !918, i32 252, metadata !1593, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1592, metadata !89, i32 252} ; [ DW_TAG_subprogram ]
!1648 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi1EEC2Ei", metadata !918, i32 252, metadata !1593, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1592, metadata !89, i32 252} ; [ DW_TAG_subprogram ]
!1649 = metadata !{i32 786478, i32 0, null, metadata !"ap_int_base", metadata !"ap_int_base", metadata !"_ZN11ap_int_baseILi1ELb0ELb1EEC2Ev", metadata !891, i32 1439, metadata !1337, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1336, metadata !89, i32 1439} ; [ DW_TAG_subprogram ]
!1650 = metadata !{i32 786478, i32 0, null, metadata !"ssdm_int", metadata !"ssdm_int", metadata !"_ZN8ssdm_intILi1ELb0EEC2Ev", metadata !925, i32 3, metadata !1333, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1332, metadata !89, i32 3} ; [ DW_TAG_subprogram ]
!1651 = metadata !{i32 786478, i32 0, null, metadata !"operator=", metadata !"operator=", metadata !"_ZN7ap_uintILi1EEaSERKS0_", metadata !918, i32 279, metadata !1642, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1641, metadata !89, i32 279} ; [ DW_TAG_subprogram ]
!1652 = metadata !{i32 786478, i32 0, null, metadata !"operator unsigned char", metadata !"operator unsigned char", metadata !"_ZNK11ap_int_baseILi2ELb0ELb1EEcvhEv", metadata !891, i32 1655, metadata !1068, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1067, metadata !89, i32 1655} ; [ DW_TAG_subprogram ]
!1653 = metadata !{i32 786478, i32 0, metadata !891, metadata !"operator<<<2, false>", metadata !"operator<<<2, false>", metadata !"_ZlsILi2ELb0EERSoS0_RK11ap_int_baseIXT_EXT0_EXleT_Li64EEE", metadata !891, i32 3300, metadata !1654, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, metadata !1200, null, metadata !89, i32 3300} ; [ DW_TAG_subprogram ]
...
!2431 = metadata !{i32 786478, i32 0, null, metadata !"operator unsigned char", metadata !"operator unsigned char", metadata !"_ZNK11ap_int_baseILi1ELb0ELb1EEcvhEv", metadata !891, i32 1655, metadata !1450, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1449, metadata !89, i32 1655} ; [ DW_TAG_subprogram ]
!2432 = metadata !{i32 786478, i32 0, metadata !4, metadata !"hex", metadata !"hex", metadata !"_ZSt3hexRSt8ios_base", metadata !5, i32 942, metadata !1842, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !89, i32 943} ; [ DW_TAG_subprogram ]
!2433 = metadata !{i32 786478, i32 0, metadata !4, metadata !"setf", metadata !"setf", metadata !"_ZNSt8ios_base4setfESt13_Ios_FmtflagsS0_", metadata !5, i32 596, metadata !843, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !842, metadata !89, i32 597} ; [ DW_TAG_subprogram ]
!2434 = metadata !{i32 786478, i32 0, metadata !4, metadata !"operator&", metadata !"operator&", metadata !"_ZStanSt13_Ios_FmtflagsS_", metadata !5, i32 76, metadata !2435, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !89, i32 77} ; [ DW_TAG_subprogram ]
...
!2437 = metadata !{i32 786478, i32 0, metadata !4, metadata !"operator|=", metadata !"operator|=", metadata !"_ZStoRRSt13_Ios_FmtflagsS_", metadata !5, i32 92, metadata !2438, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !89, i32 93} ; [ DW_TAG_subprogram ]
...
!2443 = metadata !{i32 786478, i32 0, metadata !4, metadata !"operator|", metadata !"operator|", metadata !"_ZStorSt13_Ios_FmtflagsS_", metadata !5, i32 80, metadata !2435, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !89, i32 81} ; [ DW_TAG_subprogram ]
!2444 = metadata !{i32 786478, i32 0, metadata !4, metadata !"operator~", metadata !"operator~", metadata !"_ZStcoSt13_Ios_Fmtflags", metadata !5, i32 88, metadata !2445, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !89, i32 89} ; [ DW_TAG_subprogram ]
...
!2447 = metadata !{i32 786478, i32 0, metadata !4, metadata !"operator&=", metadata !"operator&=", metadata !"_ZStaNRSt13_Ios_FmtflagsS_", metadata !5, i32 96, metadata !2438, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !89, i32 97} ; [ DW_TAG_subprogram ]
...
!2496 = metadata !{i32 786484, i32 0, metadata !2497, metadata !"__ioinit", metadata !"__ioinit", metadata !"_ZStL8__ioinit", metadata !1660, i32 74, metadata !2498, i32 1, i32 1, null} ; [ DW_TAG_variable ]
...
!2508 = metadata !{i32 786484, i32 0, null, metadata !"__is_signed", metadata !"__is_signed", metadata !"_ZN9__gnu_cxx24__numeric_traits_integer11__is_signedE", metadata !2509, i32 73, metadata !2510, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2511 = metadata !{i32 786484, i32 0, null, metadata !"__digits", metadata !"__digits", metadata !"_ZN9__gnu_cxx24__numeric_traits_integer8__digitsE", metadata !2509, i32 76, metadata !168, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2512 = metadata !{i32 786484, i32 0, null, metadata !"__max_digits10", metadata !"__max_digits10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating14__max_digits10E", metadata !2509, i32 111, metadata !168, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2513 = metadata !{i32 786484, i32 0, null, metadata !"__is_signed", metadata !"__is_signed", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating11__is_signedE", metadata !2509, i32 114, metadata !2510, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2514 = metadata !{i32 786484, i32 0, null, metadata !"__digits10", metadata !"__digits10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating10__digits10E", metadata !2509, i32 117, metadata !168, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2515 = metadata !{i32 786484, i32 0, null, metadata !"__max_exponent10", metadata !"__max_exponent10", metadata !"_ZN9__gnu_cxx25__numeric_traits_floating16__max_exponent10E", metadata !2509, i32 120, metadata !168, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2516 = metadata !{i32 786484, i32 0, null, metadata !"__daylight", metadata !"__daylight", metadata !"", metadata !2517, i32 160, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2518 = metadata !{i32 786484, i32 0, null, metadata !"__timezone", metadata !"__timezone", metadata !"", metadata !2517, i32 161, metadata !64, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2519 = metadata !{i32 786484, i32 0, null, metadata !"daylight", metadata !"daylight", metadata !"", metadata !2517, i32 174, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2520 = metadata !{i32 786484, i32 0, null, metadata !"timezone", metadata !"timezone", metadata !"", metadata !2517, i32 175, metadata !64, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2521 = metadata !{i32 786484, i32 0, null, metadata !"getdate_err", metadata !"getdate_err", metadata !"", metadata !2517, i32 280, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2522 = metadata !{i32 786484, i32 0, null, metadata !"__environ", metadata !"__environ", metadata !"", metadata !2523, i32 546, metadata !212, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2524 = metadata !{i32 786484, i32 0, null, metadata !"environ", metadata !"environ", metadata !"", metadata !2523, i32 548, metadata !212, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2525 = metadata !{i32 786484, i32 0, null, metadata !"optarg", metadata !"optarg", metadata !"", metadata !2526, i32 36, metadata !213, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2527 = metadata !{i32 786484, i32 0, null, metadata !"optind", metadata !"optind", metadata !"", metadata !2526, i32 50, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2528 = metadata !{i32 786484, i32 0, null, metadata !"opterr", metadata !"opterr", metadata !"", metadata !2526, i32 55, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2529 = metadata !{i32 786484, i32 0, null, metadata !"optopt", metadata !"optopt", metadata !"", metadata !2526, i32 59, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2530 = metadata !{i32 786484, i32 0, metadata !2531, metadata !"nothrow", metadata !"nothrow", metadata !"_ZSt7nothrow", metadata !2532, i32 70, metadata !2533, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2535 = metadata !{i32 786484, i32 0, metadata !115, metadata !"_S_classic", metadata !"_S_classic", metadata !"_ZNSt6locale10_S_classicE", metadata !117, i32 283, metadata !120, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2536 = metadata !{i32 786484, i32 0, metadata !115, metadata !"_S_global", metadata !"_S_global", metadata !"_ZNSt6locale9_S_globalE", metadata !117, i32 286, metadata !120, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2537 = metadata !{i32 786484, i32 0, metadata !115, metadata !"_S_once", metadata !"_S_once", metadata !"_ZNSt6locale7_S_onceE", metadata !117, i32 307, metadata !2538, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2540 = metadata !{i32 786484, i32 0, metadata !128, metadata !"_S_c_locale", metadata !"_S_c_locale", metadata !"_ZNSt6locale5facet11_S_c_localeE", metadata !117, i32 347, metadata !148, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2541 = metadata !{i32 786484, i32 0, metadata !128, metadata !"_S_once", metadata !"_S_once", metadata !"_ZNSt6locale5facet7_S_onceE", metadata !117, i32 353, metadata !2538, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2542 = metadata !{i32 786484, i32 0, metadata !251, metadata !"_S_refcount", metadata !"_S_refcount", metadata !"_ZNSt6locale2id11_S_refcountE", metadata !117, i32 456, metadata !84, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2543 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7collate2idE", metadata !117, i32 634, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2544 = metadata !{i32 786484, i32 0, metadata !2498, metadata !"_S_refcount", metadata !"_S_refcount", metadata !"_ZNSt8ios_base4Init11_S_refcountE", metadata !5, i32 542, metadata !84, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2545 = metadata !{i32 786484, i32 0, metadata !2498, metadata !"_S_synced_with_stdio", metadata !"_S_synced_with_stdio", metadata !"_ZNSt8ios_base4Init20_S_synced_with_stdioE", metadata !5, i32 543, metadata !238, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2546 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt5ctype2idE", metadata !2016, i32 613, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2560 = metadata !{i32 786484, i32 0, metadata !2014, metadata !"id", metadata !"id", metadata !"_ZNSt5ctypeIcE2idE", metadata !2016, i32 696, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2561 = metadata !{i32 786484, i32 0, metadata !2562, metadata !"id", metadata !"id", metadata !"_ZNSt5ctypeIwE2idE", metadata !2016, i32 1198, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2694 = metadata !{i32 786484, i32 0, metadata !2695, metadata !"_S_atoms_out", metadata !"_S_atoms_out", metadata !"_ZNSt10__num_base12_S_atoms_outE", metadata !2016, i32 1543, metadata !172, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2700 = metadata !{i32 786484, i32 0, metadata !2695, metadata !"_S_atoms_in", metadata !"_S_atoms_in", metadata !"_ZNSt10__num_base11_S_atoms_inE", metadata !2016, i32 1547, metadata !172, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2701 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt8numpunct2idE", metadata !2016, i32 1657, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2702 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7num_get2idE", metadata !2016, i32 1926, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2703 = metadata !{i32 786484, i32 0, null, metadata !"id", metadata !"id", metadata !"_ZNSt7num_put2idE", metadata !2016, i32 2264, metadata !251, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2704 = metadata !{i32 786484, i32 0, metadata !2497, metadata !"cin", metadata !"cin", metadata !"_ZSt3cin", metadata !1660, i32 60, metadata !2705, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!2706 = metadata !{i32 786484, i32 0, metadata !2497, metadata !"cout", metadata !"cout", metadata !"_ZSt4cout", metadata !1660, i32 61, metadata !1657, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2707 = metadata !{i32 786484, i32 0, metadata !2497, metadata !"cerr", metadata !"cerr", metadata !"_ZSt4cerr", metadata !1660, i32 62, metadata !1657, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2708 = metadata !{i32 786484, i32 0, metadata !2497, metadata !"clog", metadata !"clog", metadata !"_ZSt4clog", metadata !1660, i32 63, metadata !1657, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!2709 = metadata !{i32 786484, i32 0, metadata !2497, metadata !"wcin", metadata !"wcin", metadata !"_ZSt4wcin", metadata !1660, i32 66, metadata !2710, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3382 = metadata !{i32 786484, i32 0, metadata !2497, metadata !"wcout", metadata !"wcout", metadata !"_ZSt5wcout", metadata !1660, i32 67, metadata !3383, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3384 = metadata !{i32 786484, i32 0, metadata !2497, metadata !"wcerr", metadata !"wcerr", metadata !"_ZSt5wcerr", metadata !1660, i32 68, metadata !3383, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3385 = metadata !{i32 786484, i32 0, metadata !2497, metadata !"wclog", metadata !"wclog", metadata !"_ZSt5wclog", metadata !1660, i32 69, metadata !3383, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3386 = metadata !{i32 786484, i32 0, null, metadata !"_IO_2_1_stdin_", metadata !"_IO_2_1_stdin_", metadata !"", metadata !3387, i32 319, metadata !3388, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3389 = metadata !{i32 786484, i32 0, null, metadata !"_IO_2_1_stdout_", metadata !"_IO_2_1_stdout_", metadata !"", metadata !3387, i32 320, metadata !3388, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3390 = metadata !{i32 786484, i32 0, null, metadata !"_IO_2_1_stderr_", metadata !"_IO_2_1_stderr_", metadata !"", metadata !3387, i32 321, metadata !3388, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3391 = metadata !{i32 786484, i32 0, null, metadata !"sys_nerr", metadata !"sys_nerr", metadata !"", metadata !3392, i32 26, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3393 = metadata !{i32 786484, i32 0, null, metadata !"_sys_nerr", metadata !"_sys_nerr", metadata !"", metadata !3392, i32 30, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
!3394 = metadata !{i32 786484, i32 0, null, metadata !"signgam", metadata !"signgam", metadata !"", metadata !3395, i32 489, metadata !56, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3396 = metadata !{i32 786484, i32 0, metadata !3397, metadata !"SC_BIND_PROXY_NIL", metadata !"SC_BIND_PROXY_NIL", metadata !"_ZN7_ap_sc_7sc_core17SC_BIND_PROXY_NILE", metadata !3399, i32 505, metadata !3400, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!3433 = metadata !{null, metadata !3434, metadata !3435, metadata !3436, metadata !3437, metadata !3438, metadata !3439}
...
!3440 = metadata !{null, metadata !3441, metadata !3435, metadata !3442, metadata !3437, metadata !3443, metadata !3439}
...
!3444 = metadata !{null, metadata !3445, metadata !3446, metadata !3447, metadata !3448, metadata !3449, metadata !3439}
!3445 = metadata !{metadata !"kernel_arg_addr_space"}
!3446 = metadata !{metadata !"kernel_arg_access_qual"}
!3447 = metadata !{metadata !"kernel_arg_type"}
!3448 = metadata !{metadata !"kernel_arg_type_qual"}
!3449 = metadata !{metadata !"kernel_arg_name"}
!3450 = metadata !{null, metadata !3441, metadata !3435, metadata !3451, metadata !3437, metadata !3452, metadata !3439}
!3451 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_uint<1> &"}
!3452 = metadata !{metadata !"kernel_arg_name", metadata !"op2"}
!3453 = metadata !{null, metadata !3454, metadata !3455, metadata !3456, metadata !3457, metadata !3458, metadata !3439}
!3454 = metadata !{metadata !"kernel_arg_addr_space", i32 0, i32 0}
!3455 = metadata !{metadata !"kernel_arg_access_qual", metadata !"none", metadata !"none"}
!3456 = metadata !{metadata !"kernel_arg_type", metadata !"std::ostream &", metadata !"const ap_int_base<2, false> &"}
!3457 = metadata !{metadata !"kernel_arg_type_qual", metadata !"", metadata !""}
!3458 = metadata !{metadata !"kernel_arg_name", metadata !"os", metadata !"x"}
!3459 = metadata !{null, metadata !3441, metadata !3435, metadata !3460, metadata !3437, metadata !3461, metadata !3439}
!3460 = metadata !{metadata !"kernel_arg_type", metadata !"class std::ios_base &"}
!3461 = metadata !{metadata !"kernel_arg_name", metadata !"__base"}
!3462 = metadata !{null, metadata !3454, metadata !3455, metadata !3463, metadata !3457, metadata !3464, metadata !3439}
!3463 = metadata !{metadata !"kernel_arg_type", metadata !"fmtflags", metadata !"fmtflags"}
!3464 = metadata !{metadata !"kernel_arg_name", metadata !"__fmtfl", metadata !"__mask"}
!3465 = metadata !{null, metadata !3454, metadata !3455, metadata !3466, metadata !3457, metadata !3467, metadata !3439}
!3466 = metadata !{metadata !"kernel_arg_type", metadata !"enum std::_Ios_Fmtflags", metadata !"enum std::_Ios_Fmtflags"}
!3467 = metadata !{metadata !"kernel_arg_name", metadata !"__a", metadata !"__b"}
!3468 = metadata !{null, metadata !3454, metadata !3455, metadata !3469, metadata !3457, metadata !3467, metadata !3439}
!3469 = metadata !{metadata !"kernel_arg_type", metadata !"enum std::_Ios_Fmtflags &", metadata !"enum std::_Ios_Fmtflags"}
!3470 = metadata !{null, metadata !3441, metadata !3435, metadata !3471, metadata !3437, metadata !3472, metadata !3439}
!3471 = metadata !{metadata !"kernel_arg_type", metadata !"enum std::_Ios_Fmtflags"}
!3472 = metadata !{metadata !"kernel_arg_name", metadata !"__a"}
!3473 = metadata !{metadata !3474, [1 x i32]* @llvm.global_ctors.0}
!3474 = metadata !{metadata !3475}
!3475 = metadata !{i32 0, i32 31, metadata !3476}
!3476 = metadata !{metadata !3477}
!3477 = metadata !{metadata !"llvm.global_ctors.0", metadata !3478, metadata !"", i32 0, i32 31}
!3478 = metadata !{metadata !3479}
!3479 = metadata !{i32 0, i32 0, i32 1}
!3480 = metadata !{metadata !3481}
!3481 = metadata !{i32 0, i32 31, metadata !3482}
!3482 = metadata !{metadata !3483}
!3483 = metadata !{metadata !"mem_interfaces.request.address", metadata !3484, metadata !"int", i32 0, i32 31}
!3484 = metadata !{metadata !3485}
!3485 = metadata !{i32 0, i32 1, i32 1}
!3486 = metadata !{metadata !3487}
!3487 = metadata !{i32 0, i32 31, metadata !3488}
!3488 = metadata !{metadata !3489}
!3489 = metadata !{metadata !"mem_interfaces.request.data", metadata !3484, metadata !"int", i32 0, i32 31}
!3490 = metadata !{metadata !3491}
!3491 = metadata !{i32 0, i32 1, metadata !3492}
!3492 = metadata !{metadata !3493}
!3493 = metadata !{metadata !"mem_interfaces.request.op.V", metadata !3484, metadata !"uint2", i32 0, i32 1}
!3494 = metadata !{metadata !3495}
!3495 = metadata !{i32 0, i32 31, metadata !3496}
!3496 = metadata !{metadata !3497}
!3497 = metadata !{metadata !"mem_interfaces.result", metadata !3484, metadata !"int", i32 0, i32 31}
!3498 = metadata !{metadata !3499}
!3499 = metadata !{i32 0, i32 0, metadata !3500}
!3500 = metadata !{metadata !3501}
!3501 = metadata !{metadata !"mem_interfaces.ack.V", metadata !3484, metadata !"uint1", i32 0, i32 0}
!3502 = metadata !{metadata !3503}
!3503 = metadata !{i32 0, i32 0, metadata !3504}
!3504 = metadata !{metadata !3505}
!3505 = metadata !{metadata !"mem_interfaces.req.V", metadata !3484, metadata !"uint1", i32 0, i32 0}
!3506 = metadata !{i32 790531, metadata !3507, metadata !"mem_interfaces.request.address", null, i32 3, metadata !3508, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!3507 = metadata !{i32 786689, metadata !901, metadata !"mem_interfaces", metadata !902, i32 16777219, metadata !905, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3508 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 64, i64 32, i32 0, i32 0, metadata !3509, metadata !3513, i32 0, i32 0} ; [ DW_TAG_array_type ]
!3509 = metadata !{i32 786438, null, metadata !"", metadata !908, i32 33, i64 32, i64 32, i32 0, i32 0, null, metadata !3510, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!3510 = metadata !{metadata !3511}
!3511 = metadata !{i32 786438, null, metadata !"", metadata !908, i32 25, i64 32, i64 32, i32 0, i32 0, null, metadata !3512, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!3512 = metadata !{metadata !914}
!3513 = metadata !{metadata !3514}
!3514 = metadata !{i32 786465, i64 0, i64 1}      ; [ DW_TAG_subrange_type ]
!3515 = metadata !{i32 3, i32 48, metadata !901, null}
!3516 = metadata !{i32 790531, metadata !3507, metadata !"mem_interfaces.request.data", null, i32 3, metadata !3517, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!3517 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 64, i64 32, i32 0, i32 0, metadata !3518, metadata !3513, i32 0, i32 0} ; [ DW_TAG_array_type ]
!3518 = metadata !{i32 786438, null, metadata !"", metadata !908, i32 33, i64 32, i64 32, i32 0, i32 0, null, metadata !3519, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!3519 = metadata !{metadata !3520}
!3520 = metadata !{i32 786438, null, metadata !"", metadata !908, i32 25, i64 32, i64 32, i32 0, i32 0, null, metadata !3521, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!3521 = metadata !{metadata !915}
!3522 = metadata !{i32 790531, metadata !3507, metadata !"mem_interfaces.request.op.V", null, i32 3, metadata !3523, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!3523 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 4, i64 32, i32 0, i32 0, metadata !3524, metadata !3513, i32 0, i32 0} ; [ DW_TAG_array_type ]
!3524 = metadata !{i32 786438, null, metadata !"", metadata !908, i32 33, i64 2, i64 32, i32 0, i32 0, null, metadata !3525, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!3525 = metadata !{metadata !3526}
!3526 = metadata !{i32 786438, null, metadata !"", metadata !908, i32 25, i64 2, i64 32, i32 0, i32 0, null, metadata !3527, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!3527 = metadata !{metadata !3528}
!3528 = metadata !{i32 786438, null, metadata !"ap_uint<2>", metadata !918, i32 182, i64 2, i64 8, i32 0, i32 0, null, metadata !3529, i32 0, null, metadata !1313} ; [ DW_TAG_class_field_type ]
!3529 = metadata !{metadata !3530}
!3530 = metadata !{i32 786438, null, metadata !"ap_int_base<2, false, true>", metadata !891, i32 1398, i64 2, i64 8, i32 0, i32 0, null, metadata !3531, i32 0, null, metadata !1229} ; [ DW_TAG_class_field_type ]
!3531 = metadata !{metadata !3532}
!3532 = metadata !{i32 786438, null, metadata !"ssdm_int<2 + 1024 * 0, false>", metadata !925, i32 4, i64 2, i64 8, i32 0, i32 0, null, metadata !3533, i32 0, null, metadata !938} ; [ DW_TAG_class_field_type ]
!3533 = metadata !{metadata !927}
!3534 = metadata !{i32 790531, metadata !3507, metadata !"mem_interfaces.result", null, i32 3, metadata !3535, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!3535 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 64, i64 32, i32 0, i32 0, metadata !3536, metadata !3513, i32 0, i32 0} ; [ DW_TAG_array_type ]
!3536 = metadata !{i32 786438, null, metadata !"", metadata !908, i32 33, i64 32, i64 32, i32 0, i32 0, null, metadata !3537, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!3537 = metadata !{metadata !1320}
!3538 = metadata !{i32 790531, metadata !3507, metadata !"mem_interfaces.ack.V", null, i32 3, metadata !3539, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!3539 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 2, i64 32, i32 0, i32 0, metadata !3540, metadata !3513, i32 0, i32 0} ; [ DW_TAG_array_type ]
!3540 = metadata !{i32 786438, null, metadata !"", metadata !908, i32 33, i64 1, i64 32, i32 0, i32 0, null, metadata !3541, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!3541 = metadata !{metadata !3542}
!3542 = metadata !{i32 786438, null, metadata !"ap_uint<1>", metadata !918, i32 182, i64 1, i64 8, i32 0, i32 0, null, metadata !3543, i32 0, null, metadata !1645} ; [ DW_TAG_class_field_type ]
!3543 = metadata !{metadata !3544}
!3544 = metadata !{i32 786438, null, metadata !"ap_int_base<1, false, true>", metadata !891, i32 1398, i64 1, i64 8, i32 0, i32 0, null, metadata !3545, i32 0, null, metadata !1571} ; [ DW_TAG_class_field_type ]
!3545 = metadata !{metadata !3546}
!3546 = metadata !{i32 786438, null, metadata !"ssdm_int<1 + 1024 * 0, false>", metadata !925, i32 3, i64 1, i64 8, i32 0, i32 0, null, metadata !3547, i32 0, null, metadata !1073} ; [ DW_TAG_class_field_type ]
!3547 = metadata !{metadata !1330}
!3548 = metadata !{i32 790531, metadata !3507, metadata !"mem_interfaces.req.V", null, i32 3, metadata !3539, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!3549 = metadata !{i32 786688, metadata !3550, metadata !"global_memory", metadata !902, i32 5, metadata !3551, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3550 = metadata !{i32 786443, metadata !901, i32 4, i32 1, metadata !902, i32 0} ; [ DW_TAG_lexical_block ]
!3551 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 32768, i64 32, i32 0, i32 0, metadata !56, metadata !3552, i32 0, i32 0} ; [ DW_TAG_array_type ]
!3552 = metadata !{metadata !3553}
!3553 = metadata !{i32 786465, i64 0, i64 1023}   ; [ DW_TAG_subrange_type ]
!3554 = metadata !{i32 5, i32 6, metadata !3550, null}
!3555 = metadata !{i32 10, i32 16, metadata !3556, null}
!3556 = metadata !{i32 786443, metadata !3557, i32 10, i32 3, metadata !902, i32 2} ; [ DW_TAG_lexical_block ]
!3557 = metadata !{i32 786443, metadata !3550, i32 8, i32 2, metadata !902, i32 1} ; [ DW_TAG_lexical_block ]
!3558 = metadata !{i32 64, i32 1, metadata !3550, null}
!3559 = metadata !{i32 14, i32 7, metadata !3560, null}
!3560 = metadata !{i32 786443, metadata !3556, i32 11, i32 3, metadata !902, i32 3} ; [ DW_TAG_lexical_block ]
!3561 = metadata !{i32 1655, i32 70, metadata !3562, metadata !3559}
!3562 = metadata !{i32 786443, metadata !2431, i32 1655, i32 68, metadata !891, i32 15} ; [ DW_TAG_lexical_block ]
!3563 = metadata !{i32 16, i32 52, metadata !3564, null}
!3564 = metadata !{i32 786443, metadata !3560, i32 15, i32 4, metadata !902, i32 4} ; [ DW_TAG_lexical_block ]
!3565 = metadata !{i32 790529, metadata !3566, metadata !"request.address", null, i32 16, metadata !3511, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3566 = metadata !{i32 786688, metadata !3564, metadata !"request", metadata !902, i32 16, metadata !911, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3567 = metadata !{i32 790529, metadata !3566, metadata !"request.data", null, i32 16, metadata !3520, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3568 = metadata !{i32 790529, metadata !3566, metadata !"request.op.V", null, i32 16, metadata !3526, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3569 = metadata !{i32 25, i32 6, metadata !3570, null}
!3570 = metadata !{i32 786443, metadata !3564, i32 25, i32 5, metadata !902, i32 5} ; [ DW_TAG_lexical_block ]
!3571 = metadata !{i32 26, i32 1, metadata !3570, null}
!3572 = metadata !{i32 30, i32 52, metadata !3570, null}
!3573 = metadata !{i32 786688, metadata !3564, metadata !"result", metadata !902, i32 17, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3574 = metadata !{i32 39, i32 16, metadata !3575, null}
!3575 = metadata !{i32 786443, metadata !3570, i32 35, i32 6, metadata !902, i32 6} ; [ DW_TAG_lexical_block ]
!3576 = metadata !{i32 786688, metadata !3570, metadata !"read_data", metadata !902, i32 30, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3577 = metadata !{i32 36, i32 15, metadata !3575, null}
!3578 = metadata !{i32 37, i32 15, metadata !3575, null}
!3579 = metadata !{i32 38, i32 15, metadata !3575, null}
!3580 = metadata !{i32 44, i32 6, metadata !3570, null}
!3581 = metadata !{i32 45, i32 5, metadata !3570, null}
!3582 = metadata !{i32 47, i32 6, metadata !3583, null}
!3583 = metadata !{i32 786443, metadata !3564, i32 47, i32 5, metadata !902, i32 7} ; [ DW_TAG_lexical_block ]
!3584 = metadata !{i32 48, i32 1, metadata !3583, null}
!3585 = metadata !{i32 51, i32 6, metadata !3583, null}
!3586 = metadata !{i32 280, i32 10, metadata !3587, metadata !3588}
!3587 = metadata !{i32 786443, metadata !1651, i32 279, i32 92, metadata !918, i32 12} ; [ DW_TAG_lexical_block ]
!3588 = metadata !{i32 52, i32 6, metadata !3583, null}
!3589 = metadata !{i32 53, i32 6, metadata !3583, null}
!3590 = metadata !{i32 280, i32 10, metadata !3587, metadata !3591}
!3591 = metadata !{i32 54, i32 6, metadata !3583, null}
!3592 = metadata !{i32 55, i32 5, metadata !3583, null}
!3593 = metadata !{i32 56, i32 4, metadata !3564, null}
!3594 = metadata !{i32 10, i32 25, metadata !3556, null}
!3595 = metadata !{i32 786688, metadata !3556, metadata !"i", metadata !902, i32 10, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]

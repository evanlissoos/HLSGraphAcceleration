; ModuleID = '/home/parallels/Documents/ece527/final_project/global_memory/solution1/.autopilot/db/a.g.1.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.CoreGlobalMemoryInterface_t.33 = type { %struct.atomicreq_t.29, i32, %struct.ap_uint.0.32, %struct.ap_uint.0.32 }
%struct.atomicreq_t.29 = type { i32, i32, %struct.ap_uint.28 }
%struct.ap_uint.28 = type { %struct.ap_int_base.27 }
%struct.ap_int_base.27 = type { %struct.ssdm_int.26 }
%struct.ssdm_int.26 = type { i2 }
%struct.ap_uint.0.32 = type { %struct.ap_int_base.1.31 }
%struct.ap_int_base.1.31 = type { %struct.ssdm_int.2.30 }
%struct.ssdm_int.2.30 = type { i1 }
...
; [#uses=0]
define void @global_memory(%struct.CoreGlobalMemoryInterface_t.33* %mem_interfaces) nounwind uwtable {
  call void (...)* @_ssdm_op_SpecTopModule([14 x i8]* @global_memory.str) nounwind
  %global_memory = alloca [1024 x i32], align 16  ; [#uses=2 type=[1024 x i32]*]
  call void @llvm.dbg.value(metadata !{%struct.CoreGlobalMemoryInterface_t.33* %mem_interfaces}, i64 0, metadata !3473), !dbg !3474 ; [debug line = 3:48] [debug variable = mem_interfaces]
  call void (...)* @_ssdm_SpecArrayDimSize(%struct.CoreGlobalMemoryInterface_t.33* %mem_interfaces, i32 2) nounwind, !dbg !3475 ; [debug line = 4:2]
  call void @llvm.dbg.declare(metadata !{[1024 x i32]* %global_memory}, metadata !3477), !dbg !3481 ; [debug line = 5:6] [debug variable = global_memory]
  br label %1, !dbg !3482                         ; [debug line = 10:16]

; <label>:1                                       ; preds = %._crit_edge, %0
  %i = phi i32 [ 0, %0 ], [ %i.2, %._crit_edge ]  ; [#uses=3 type=i32]
  %exitcond1 = icmp eq i32 %i, 2, !dbg !3482      ; [#uses=1 type=i1] [debug line = 10:16]
  br i1 %exitcond1, label %.preheader, label %2, !dbg !3482 ; [debug line = 10:16]

.preheader:                                       ; preds = %1
  br label %7, !dbg !3485                         ; [debug line = 61:16]

; <label>:2                                       ; preds = %1
  %tmp = sext i32 %i to i64, !dbg !3487           ; [#uses=6 type=i64] [debug line = 14:7]
  %mem_interfaces.addr = getelementptr inbounds %struct.CoreGlobalMemoryInterface_t.33* %mem_interfaces, i64 %tmp, i32 3, i32 0, i32 0, i32 0, !dbg !3489 ; [#uses=1 type=i1*] [debug line = 1655:70@14:7]
  %mem_interfaces.load = load i1* %mem_interfaces.addr, align 1, !dbg !3489 ; [#uses=2 type=i1] [debug line = 1655:70@14:7]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %mem_interfaces.load) nounwind
  br i1 %mem_interfaces.load, label %3, label %._crit_edge, !dbg !3487 ; [debug line = 14:7]

; <label>:3                                       ; preds = %2
  %mem_interfaces.addr.1 = getelementptr inbounds %struct.CoreGlobalMemoryInterface_t.33* %mem_interfaces, i64 %tmp, i32 0, i32 0, !dbg !3491 ; [#uses=1 type=i32*] [debug line = 16:52]
  %request.address = load i32* %mem_interfaces.addr.1, align 4, !dbg !3491 ; [#uses=2 type=i32] [debug line = 16:52]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %request.address) nounwind
  call void @llvm.dbg.value(metadata !{i32 %request.address}, i64 0, metadata !3493), !dbg !3491 ; [debug line = 16:52] [debug variable = request.address]
  %mem_interfaces.addr.2 = getelementptr inbounds %struct.CoreGlobalMemoryInterface_t.33* %mem_interfaces, i64 %tmp, i32 0, i32 1, !dbg !3491 ; [#uses=1 type=i32*] [debug line = 16:52]
  %request.data = load i32* %mem_interfaces.addr.2, align 4, !dbg !3491 ; [#uses=6 type=i32] [debug line = 16:52]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %request.data) nounwind
  call void @llvm.dbg.value(metadata !{i32 %request.data}, i64 0, metadata !3497), !dbg !3491 ; [debug line = 16:52] [debug variable = request.data]
  %mem_interfaces.addr.3 = getelementptr inbounds %struct.CoreGlobalMemoryInterface_t.33* %mem_interfaces, i64 %tmp, i32 0, i32 2, i32 0, i32 0, i32 0, !dbg !3491 ; [#uses=1 type=i2*] [debug line = 16:52]
  %request.op.V = load i2* %mem_interfaces.addr.3, align 1, !dbg !3491 ; [#uses=2 type=i2] [debug line = 16:52]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i2 %request.op.V) nounwind
  call void @llvm.dbg.value(metadata !{i2 %request.op.V}, i64 0, metadata !3500), !dbg !3491 ; [debug line = 16:52] [debug variable = request.op.V]
  %rbegin1 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !3509 ; [#uses=1 type=i32] [debug line = 25:6]
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, i8* getelementptr inbounds ([1 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !3511 ; [debug line = 26:1]
  %tmp.1 = sext i32 %request.address to i64, !dbg !3512 ; [#uses=1 type=i64] [debug line = 30:52]
  %global_memory.addr = getelementptr inbounds [1024 x i32]* %global_memory, i64 0, i64 %tmp.1, !dbg !3512 ; [#uses=2 type=i32*] [debug line = 30:52]
  %result.4 = load i32* %global_memory.addr, align 4, !dbg !3512 ; [#uses=7 type=i32] [debug line = 30:52]
  call void @llvm.dbg.value(metadata !{i32 %result.4}, i64 0, metadata !3513), !dbg !3514 ; [debug line = 39:16] [debug variable = result]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %result.4) nounwind
  call void @llvm.dbg.value(metadata !{i32 %result.4}, i64 0, metadata !3516), !dbg !3512 ; [debug line = 30:52] [debug variable = read_data]
  %tmp.2 = zext i2 %request.op.V to i32, !dbg !3517 ; [#uses=1 type=i32] [debug line = 34:13]
  switch i32 %tmp.2, label %._crit_edge24 [
    i32 1, label %4
    i32 2, label %5
    i32 3, label %6
  ], !dbg !3517                                   ; [debug line = 34:13]

; <label>:4                                       ; preds = %3
  %result = add nsw i32 %result.4, %request.data, !dbg !3518 ; [#uses=1 type=i32] [debug line = 36:15]
  call void @llvm.dbg.value(metadata !{i32 %result}, i64 0, metadata !3513), !dbg !3518 ; [debug line = 36:15] [debug variable = result]
  br label %._crit_edge24, !dbg !3519             ; [debug line = 36:50]

; <label>:5                                       ; preds = %3
  %tmp.6 = icmp sgt i32 %result.4, %request.data, !dbg !3520 ; [#uses=1 type=i1] [debug line = 37:15]
  %request.data.2 = select i1 %tmp.6, i32 %request.data, i32 %result.4, !dbg !3520 ; [#uses=1 type=i32] [debug line = 37:15]
  call void @llvm.dbg.value(metadata !{i32 %request.data.2}, i64 0, metadata !3497), !dbg !3520 ; [debug line = 37:15] [debug variable = request.data]
  call void @llvm.dbg.value(metadata !{i32 %request.data.2}, i64 0, metadata !3513), !dbg !3520 ; [debug line = 37:15] [debug variable = result]
  br label %._crit_edge24, !dbg !3521             ; [debug line = 37:79]

; <label>:6                                       ; preds = %3
  %tmp.8 = icmp sgt i32 %result.4, %request.data, !dbg !3522 ; [#uses=1 type=i1] [debug line = 38:15]
  %result.2 = select i1 %tmp.8, i32 %result.4, i32 %request.data, !dbg !3522 ; [#uses=1 type=i32] [debug line = 38:15]
  call void @llvm.dbg.value(metadata !{i32 %result.2}, i64 0, metadata !3513), !dbg !3522 ; [debug line = 38:15] [debug variable = result]
  call void @llvm.dbg.value(metadata !{i32 %result.2}, i64 0, metadata !3513), !dbg !3522 ; [debug line = 38:15] [debug variable = result]
  br label %._crit_edge24, !dbg !3523             ; [debug line = 38:79]

._crit_edge24:                                    ; preds = %6, %5, %4, %3
  %result3 = phi i32 [ %result.2, %6 ], [ %request.data.2, %5 ], [ %result, %4 ], [ %result.4, %3 ] ; [#uses=2 type=i32]
  store i32 %result3, i32* %global_memory.addr, align 4, !dbg !3524 ; [debug line = 44:6]
  %rend26 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str6, i64 0, i64 0), i32 %rbegin1) nounwind, !dbg !3525 ; [#uses=0 type=i32] [debug line = 45:5]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str11, i64 0, i64 0)) nounwind, !dbg !3526 ; [#uses=1 type=i32] [debug line = 47:6]
  call void (...)* @_ssdm_op_SpecProtocol(i32 1, i8* getelementptr inbounds ([1 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !3528 ; [debug line = 48:1]
  %mem_interfaces.addr.4 = getelementptr inbounds %struct.CoreGlobalMemoryInterface_t.33* %mem_interfaces, i64 %tmp, i32 1, !dbg !3529 ; [#uses=1 type=i32*] [debug line = 51:6]
  store i32 %result3, i32* %mem_interfaces.addr.4, align 4, !dbg !3529 ; [debug line = 51:6]
  %mem_interfaces.addr.5 = getelementptr inbounds %struct.CoreGlobalMemoryInterface_t.33* %mem_interfaces, i64 %tmp, i32 2, i32 0, i32 0, i32 0, !dbg !3530 ; [#uses=2 type=i1*] [debug line = 280:10@52:6]
  store i1 true, i1* %mem_interfaces.addr.5, align 1, !dbg !3530 ; [debug line = 280:10@52:6]
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !3533 ; [debug line = 53:6]
  store i1 false, i1* %mem_interfaces.addr.5, align 1, !dbg !3534 ; [debug line = 280:10@54:6]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str11, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !3536 ; [#uses=0 type=i32] [debug line = 55:5]
  br label %._crit_edge, !dbg !3537               ; [debug line = 56:4]

._crit_edge:                                      ; preds = %._crit_edge24, %2
  %i.2 = add nsw i32 %i, 1, !dbg !3538            ; [#uses=1 type=i32] [debug line = 10:25]
  call void @llvm.dbg.value(metadata !{i32 %i.2}, i64 0, metadata !3539), !dbg !3538 ; [debug line = 10:25] [debug variable = i]
  br label %1, !dbg !3538                         ; [debug line = 10:25]

; <label>:7                                       ; preds = %8, %.preheader
  %i1 = phi i32 [ %i.1, %8 ], [ 0, %.preheader ]  ; [#uses=3 type=i32]
  %exitcond = icmp eq i32 %i1, 10, !dbg !3485     ; [#uses=1 type=i1] [debug line = 61:16]
  br i1 %exitcond, label %9, label %8, !dbg !3485 ; [debug line = 61:16]

; <label>:8                                       ; preds = %7
  %tmp.3 = sext i32 %i1 to i64, !dbg !3540        ; [#uses=1 type=i64] [debug line = 62:4]
  %global_memory.addr.1 = getelementptr inbounds [1024 x i32]* %global_memory, i64 0, i64 %tmp.3, !dbg !3540 ; [#uses=1 type=i32*] [debug line = 62:4]
  %global_memory.load = load i32* %global_memory.addr.1, align 4, !dbg !3540 ; [#uses=1 type=i32] [debug line = 62:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %global_memory.load) nounwind
  %i.1 = add nsw i32 %i1, 1, !dbg !3541           ; [#uses=1 type=i32] [debug line = 61:26]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !3542), !dbg !3541 ; [debug line = 61:26] [debug variable = i]
  br label %7, !dbg !3541                         ; [debug line = 61:26]

; <label>:9                                       ; preds = %7
  ret void, !dbg !3543                            ; [debug line = 64:1]
}
...
!3433 = metadata !{void (%struct.CoreGlobalMemoryInterface_t.33*)* @global_memory, metadata !3434, metadata !3435, metadata !3436, metadata !3437, metadata !3438, metadata !3439}
...
!3473 = metadata !{i32 786689, metadata !901, metadata !"mem_interfaces", metadata !902, i32 16777219, metadata !905, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3474 = metadata !{i32 3, i32 48, metadata !901, null}
!3475 = metadata !{i32 4, i32 2, metadata !3476, null}
!3476 = metadata !{i32 786443, metadata !901, i32 4, i32 1, metadata !902, i32 0} ; [ DW_TAG_lexical_block ]
!3477 = metadata !{i32 786688, metadata !3476, metadata !"global_memory", metadata !902, i32 5, metadata !3478, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3478 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 32768, i64 32, i32 0, i32 0, metadata !56, metadata !3479, i32 0, i32 0} ; [ DW_TAG_array_type ]
!3479 = metadata !{metadata !3480}
!3480 = metadata !{i32 786465, i64 0, i64 1023}   ; [ DW_TAG_subrange_type ]
!3481 = metadata !{i32 5, i32 6, metadata !3476, null}
!3482 = metadata !{i32 10, i32 16, metadata !3483, null}
!3483 = metadata !{i32 786443, metadata !3484, i32 10, i32 3, metadata !902, i32 2} ; [ DW_TAG_lexical_block ]
!3484 = metadata !{i32 786443, metadata !3476, i32 8, i32 2, metadata !902, i32 1} ; [ DW_TAG_lexical_block ]
!3485 = metadata !{i32 61, i32 16, metadata !3486, null}
!3486 = metadata !{i32 786443, metadata !3484, i32 61, i32 3, metadata !902, i32 8} ; [ DW_TAG_lexical_block ]
!3487 = metadata !{i32 14, i32 7, metadata !3488, null}
!3488 = metadata !{i32 786443, metadata !3483, i32 11, i32 3, metadata !902, i32 3} ; [ DW_TAG_lexical_block ]
!3489 = metadata !{i32 1655, i32 70, metadata !3490, metadata !3487}
!3490 = metadata !{i32 786443, metadata !2431, i32 1655, i32 68, metadata !891, i32 15} ; [ DW_TAG_lexical_block ]
!3491 = metadata !{i32 16, i32 52, metadata !3492, null}
!3492 = metadata !{i32 786443, metadata !3488, i32 15, i32 4, metadata !902, i32 4} ; [ DW_TAG_lexical_block ]
!3493 = metadata !{i32 790529, metadata !3494, metadata !"request.address", null, i32 16, metadata !3495, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3494 = metadata !{i32 786688, metadata !3492, metadata !"request", metadata !902, i32 16, metadata !911, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3495 = metadata !{i32 786438, null, metadata !"", metadata !908, i32 25, i64 32, i64 32, i32 0, i32 0, null, metadata !3496, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!3496 = metadata !{metadata !914}
!3497 = metadata !{i32 790529, metadata !3494, metadata !"request.data", null, i32 16, metadata !3498, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3498 = metadata !{i32 786438, null, metadata !"", metadata !908, i32 25, i64 32, i64 32, i32 0, i32 0, null, metadata !3499, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!3499 = metadata !{metadata !915}
!3500 = metadata !{i32 790529, metadata !3494, metadata !"request.op.V", null, i32 16, metadata !3501, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3501 = metadata !{i32 786438, null, metadata !"", metadata !908, i32 25, i64 2, i64 32, i32 0, i32 0, null, metadata !3502, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!3502 = metadata !{metadata !3503}
!3503 = metadata !{i32 786438, null, metadata !"ap_uint<2>", metadata !918, i32 182, i64 2, i64 8, i32 0, i32 0, null, metadata !3504, i32 0, null, metadata !1313} ; [ DW_TAG_class_field_type ]
!3504 = metadata !{metadata !3505}
!3505 = metadata !{i32 786438, null, metadata !"ap_int_base<2, false, true>", metadata !891, i32 1398, i64 2, i64 8, i32 0, i32 0, null, metadata !3506, i32 0, null, metadata !1229} ; [ DW_TAG_class_field_type ]
!3506 = metadata !{metadata !3507}
!3507 = metadata !{i32 786438, null, metadata !"ssdm_int<2 + 1024 * 0, false>", metadata !925, i32 4, i64 2, i64 8, i32 0, i32 0, null, metadata !3508, i32 0, null, metadata !938} ; [ DW_TAG_class_field_type ]
!3508 = metadata !{metadata !927}
!3509 = metadata !{i32 25, i32 6, metadata !3510, null}
!3510 = metadata !{i32 786443, metadata !3492, i32 25, i32 5, metadata !902, i32 5} ; [ DW_TAG_lexical_block ]
!3511 = metadata !{i32 26, i32 1, metadata !3510, null}
!3512 = metadata !{i32 30, i32 52, metadata !3510, null}
!3513 = metadata !{i32 786688, metadata !3492, metadata !"result", metadata !902, i32 17, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3514 = metadata !{i32 39, i32 16, metadata !3515, null}
!3515 = metadata !{i32 786443, metadata !3510, i32 35, i32 6, metadata !902, i32 6} ; [ DW_TAG_lexical_block ]
!3516 = metadata !{i32 786688, metadata !3510, metadata !"read_data", metadata !902, i32 30, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3517 = metadata !{i32 34, i32 13, metadata !3510, null}
!3518 = metadata !{i32 36, i32 15, metadata !3515, null}
!3519 = metadata !{i32 36, i32 50, metadata !3515, null}
!3520 = metadata !{i32 37, i32 15, metadata !3515, null}
!3521 = metadata !{i32 37, i32 79, metadata !3515, null}
!3522 = metadata !{i32 38, i32 15, metadata !3515, null}
!3523 = metadata !{i32 38, i32 79, metadata !3515, null}
!3524 = metadata !{i32 44, i32 6, metadata !3510, null}
!3525 = metadata !{i32 45, i32 5, metadata !3510, null}
!3526 = metadata !{i32 47, i32 6, metadata !3527, null}
!3527 = metadata !{i32 786443, metadata !3492, i32 47, i32 5, metadata !902, i32 7} ; [ DW_TAG_lexical_block ]
!3528 = metadata !{i32 48, i32 1, metadata !3527, null}
!3529 = metadata !{i32 51, i32 6, metadata !3527, null}
!3530 = metadata !{i32 280, i32 10, metadata !3531, metadata !3532}
!3531 = metadata !{i32 786443, metadata !1651, i32 279, i32 92, metadata !918, i32 12} ; [ DW_TAG_lexical_block ]
!3532 = metadata !{i32 52, i32 6, metadata !3527, null}
!3533 = metadata !{i32 53, i32 6, metadata !3527, null}
!3534 = metadata !{i32 280, i32 10, metadata !3531, metadata !3535}
!3535 = metadata !{i32 54, i32 6, metadata !3527, null}
!3536 = metadata !{i32 55, i32 5, metadata !3527, null}
!3537 = metadata !{i32 56, i32 4, metadata !3492, null}
!3538 = metadata !{i32 10, i32 25, metadata !3483, null}
!3539 = metadata !{i32 786688, metadata !3483, metadata !"i", metadata !902, i32 10, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3540 = metadata !{i32 62, i32 4, metadata !3486, null}
!3541 = metadata !{i32 61, i32 26, metadata !3486, null}
!3542 = metadata !{i32 786688, metadata !3486, metadata !"i", metadata !902, i32 61, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3543 = metadata !{i32 64, i32 1, metadata !3476, null}

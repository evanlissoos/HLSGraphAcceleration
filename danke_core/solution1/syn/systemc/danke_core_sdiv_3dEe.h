...
#ifndef __danke_core_sdiv_3dEe__HH__
#define __danke_core_sdiv_3dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(danke_core_sdiv_3dEe) {
    ...
    SC_CTOR(danke_core_sdiv_3dEe):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
